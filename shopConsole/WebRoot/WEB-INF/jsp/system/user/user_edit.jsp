...
<body>
	<form action="${ctx}/user/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><br/><img src="${ctxStatic}/images/jiazai.gif" /><br/><h4 class="lighter block green"></h4></div>
