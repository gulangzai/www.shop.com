...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="${ctx}/user/listUsers.do" method="post" name="userForm" id="userForm">
			<table>
				<tr>
					<td>
					...
					<td style="vertical-align:top;"><a class="btn btn-mini btn-light" onclick="window.location.href='${ctx}/user/listtabUsers.do';" title="切换模式"><i id="nav-search-icon" class="icon-exchange"></i></a></td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function toExcel(){
			...
			window.location.href='${ctx}/user/excel.do?USERNAME='+USERNAME+'&lastLoginStart='+lastLoginStart+'&lastLoginEnd='+lastLoginEnd+'&ROLE_ID='+ROLE_ID;
		}
