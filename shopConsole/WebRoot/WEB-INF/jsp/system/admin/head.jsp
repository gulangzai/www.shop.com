<div class="navbar navbar-inverse">
			  ...
			  <ul class="nav ace-nav pull-right">
					...
					<li class="green">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Alex's Avatar" class="msg-photo" src="${ctxStatic}/avatars/avatar.png" />
									<span class="msg-body">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Susan's Avatar" class="msg-photo" src="${ctxStatic}/avatars/avatar3.png" />
									<span class="msg-body">
										<span class="msg-title">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Bob's Avatar" class="msg-photo" src="${ctxStatic}/avatars/avatar4.png" />
									<span class="msg-body">
										<span class="msg-title">
					...
					<li class="light-blue user-profile">
						<a class="user-menu dropdown-toggle" href="javascript:;" data-toggle="dropdown">
							<img alt="FH" src="${ctxStatic}/avatars/user.jpg" class="nav-user-photo" />
							<span id="user_info">
							</span>
		...
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${ctxStatic}/js/myjs/head.js"></script>
