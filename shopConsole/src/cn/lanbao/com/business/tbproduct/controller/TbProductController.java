package cn.lanbao.com.business.tbproduct.controller;
...
import cn.lanbao.com.business.standard.service.StandardService;
import cn.lanbao.com.business.tbproduct.service.TProductService;
...
public class TbProductController extends BaseController {
	...
	String menuUrl = "tproductController/list.do"; //菜单地址(权限用)
	...
	public ModelAndView save() throws Exception{
		...
		int productId = tproductService.save(pd);
	...
	public ModelAndView list(Page page){
		...
		try{
			pd = this.getPageData();
			page.setPd(pd);
			List<PageData>	varList = tproductService.list(page);	//列出TProductController列表
			mv.setViewName("information/tproduct/tproduct_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("information/tproduct/tproduct_edit");
	...
	public ModelAndView goEdit(){
		...
		pd = this.getPageData();
		try {
			pd = tproductService.findById(pd);	//根据ID读取
			mv.setViewName("information/tproduct/tproduct_edit");
	...
	public Object deleteAll() {
		...
		try {
			...
			if(null != DATA_IDS && !"".equals(DATA_IDS)){
				...
				tproductService.deleteAll(ArrayDATA_IDS);
				pd.put("msg", "ok");
			}else{
				pd.put("msg", "no");
			}
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			List<PageData> varOList = tproductService.listAll(pd);
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var4", varOList.get(i).getString("F_CLSID"));	//4
