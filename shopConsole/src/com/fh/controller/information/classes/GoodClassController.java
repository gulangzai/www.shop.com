package com.fh.controller.information.classes;
...
import com.fh.entity.information.TClass;
...
import com.fh.service.information.pictures.ClassService;
...
public class GoodClassController extends BaseController {
	...
	public void deleteU(PrintWriter out){
		...
		//	if(Jurisdiction.buttonJurisdiction(menuUrl, "del")){classService.deleteU(pd);}
			out.write("success");
			out.close();
		} catch(Exception e){
	...
	public ModelAndView listClass(Page page,Model model){
		...
		List<PageData> classList;
		try {  
			classList = classService.list(pd);  
