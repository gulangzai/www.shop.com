...
import javacommon.util.alipay.config.AlipayConfig;
import javacommon.util.alipay.util.httpClient.HttpProtocolHandler;
import javacommon.util.alipay.util.httpClient.HttpRequest;
import javacommon.util.alipay.util.httpClient.HttpResponse;
import javacommon.util.alipay.util.httpClient.HttpResultType;
