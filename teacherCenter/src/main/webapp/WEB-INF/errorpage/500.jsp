...
<div class="page">
 ...
 <div class="wrap">
  <div class="sorry_one"><img src="${ctxStatic }/images/505_07.png"/>
  </div>
  <div class="five"><span class="sorry_tit">
  很抱歉，因为意外情况，服务器不能完成请求!请稍后重新尝试!!!</span>
  </div>
  <div class="black"><a href="${ctx}/homePage/toIndex.do">返回首页</a></div>
 </div>
 <%-- <div class="wrap">
  <div class="sorry_one"><img src="${ctxStatic }/images/icon_03.png"/>
  <span class="sorry_tit">很抱歉，因为意外情况，服务器不能完成请求!</span>
  </div>
  <span class="five"><img src="${ctxStatic }/images/505_07.png"/></span>
  <div class="black"><a href="${ctx}/homePage/toIndex.do">返回首页</a></div>
 </div> --%>
