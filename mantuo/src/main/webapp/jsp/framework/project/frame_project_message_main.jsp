...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String root_uid = request.getParameter("root_uid"); 
%>
...
<body class="no-skin" >
  	<%@ include file="/jsp/framework/project/message_project_top.jsp"%>
			...
			<div class="main-content"> 
				<div class="page-content"> 
				 <%@ include file="/jsp/framework/common/setting.jsp"%>	 			
					...
					<%@ include file="/jsp/business/message/message-index.jsp"%>	
  ...
  <script type="text/javascript">
	...
	function GetData(){
	 ...
	 jQuery(function($) {
    	 ...
    	 if(root_uid=='6'){
    		 GetData();
    		 _url = 'page/framework/project/frame_project_index';
    	 }
    	 	if('enable_ajax_content' in ace) {
				var options = {
