								...
								<div class="widget-body" >
									   <div class="widget-main" >
											...
											<!--可以再此处加入hidden域作为过滤条件 -->
												<input type="hidden" fieldname="LEVELNO" id="LEVELNO" name="LEVELNO" />
											<!--可以再此处加入hidden域作为过滤条件 -->
													...
													<div class="form-group" >
														...
														<div class="col-sm-9">
															<select  id="APP_NAME" name="APP_NAME" fieldname="APP_NAME" kind="dic" src="APP_NAME"></select>
														</div>
													</div>
													...
													<div class="form-group" >
														...
														<div class="col-sm-9">
															<input type="text"  id="NAME" name="NAME" fieldname="NAME" >
														</div>
													</div>
													...
													<div class="form-group" >
														...
														<div class="col-sm-9">
															<input type="text"  id="TITLE" name="TITLE" fieldname="TITLE" />
														</div>
													</div>
													...
													<div class="form-group" >
														...
														<div class="col-sm-9">
															<input type="text" id="PARENT" name="PARENT" fieldname="PARENT" >
														</div>
													</div>
													...
													<div class="form-group" >
														...
														<div class="col-sm-9">
															<input type="number"  id="ORDERNO" name="ORDERNO" fieldname="ORDERNO" >
														</div>
													</div>
													...
													<div class="form-group" >
														...
														<div class="col-sm-9">
															<select type="text"  id="TARGET" name="TARGET" fieldname="TARGET" kind="dic" src="YMXSQY"></select>
														</div>
													</div>
													...
													<div class="form-group" >
														...
														<div class="col-sm-9">
															<input type="text"  id="LOCATION" name="LOCATION" fieldname="LOCATION" >
														</div>
													</div>
											</form>
											<form method="post" id="queryPageResourceForm"  style="display :none;">
											  		...
											  		<div class="form-group" >
														...
														<div class="col-sm-9">
															<input id="PAGE_NAME" type="text"  fieldname="NAME" name = "NAME" />
														</div>
													</div>
											  		...
											  		<div class="form-group" >
														...
														<div class="col-sm-9">
															<input  id="PAGE_PARENT" type="text" fieldname="PARENT" name = "PARENT" disabled/>
														</div>
													</div>
											  		<div class="form-group" >
												  		<label class="col-sm-2 control-label no-padding-right" >
														...
														<div class="col-sm-9">
															<textarea  rows="2" id="PAGE_MEMO" check-type="maxlength" maxlength="4000" fieldname="MEMO" name="MEMO"></textarea>
														</div>
													</div>
											</form>
										</div>	
   ...
   <!--可以再此处加入hidden域作为过滤条件 -->
   	<TR  style="display:none;">
     	<TD class="right-border bottom-border">
      	<INPUT type="text"  kind="text" id="QUD"   fieldname="ORGANIZE_UID" value="" operation="="/>
