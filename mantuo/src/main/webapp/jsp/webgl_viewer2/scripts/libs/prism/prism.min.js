      ...
      , t = self.Prism = {
        ...
        languages: {
            ...
            DFS: function(e, n) {
                for (var r in e)
                    n.call(e, r, e[r]),
                    "Object" === t.util.type(e) && t.languages.DFS(e[r], n)
            }
        },
                ...
                if (c) {
                    ...
                    a && self.Worker) {
                        ...
                        u.onmessage = function(e) {
                            g.highlightedCode = n.stringify(JSON.parse(e.data), o),
                        ...
                        for (var h = 0; h < a.length; h++) {
                            ...
                            if (!(d instanceof r)) {
                                ...
                                if (p) {
                                    ...
                                    w.push(N),
                                    b && w.push(b),
                                    Array.prototype.splice.apply(a, w)
                                }
                            }
                        }
                    }
    ...
    !self.document)
        return self.addEventListener ? (self.addEventListener("message", function(e) {
            var n = JSON.parse(e.data)
              , r = n.language
              , a = n.code;
            self.postMessage(JSON.stringify(t.tokenize(a, t.languages[r]))),
            self.close()
        }
        , !1),
