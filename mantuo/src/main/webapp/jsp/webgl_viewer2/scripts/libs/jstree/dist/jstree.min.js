    ...
    if (!e.jstree) {
        ...
        e.jstree.create = function(t, s) {
            var r = new e.jstree.core(++i)
              , n = s;
            return s = e.extend(!0, {}, e.jstree.defaults, s),
            n && n.plugins && (s.plugins = n.plugins),
            e.each(s.plugins, function(e, t) {
        ...
        e.jstree.core.prototype = {
            ...
            bind: function() {
                ...
                , this)).on("keydown.jstree", ".jstree-anchor", e.proxy(function(t) {
                    ...
                    case 37:
                        t.preventDefault(),
                        this.is_open(t.currentTarget) ? this.close_node(t.currentTarget) : (i = this.get_prev_dom(t.currentTarget),
                ...
                , this)).on("load_node.jstree", e.proxy(function(t, i) {
                    ...
                    this.trigger("loaded")),
                    !this._data.core.ready && !this.get_container_ul().find(".jstree-loading:eq(0)").length)) {
                        if (this._data.core.ready = !0,
                        this._data.core.selected.length) {
                            if (this.settings.core.expand_selected_onload) {
                                var s = [], r, n;
                                for (r = 0,
                                n = this._data.core.selected.length; n > r; r++)
                                    s = s.concat(this._model.data[this._data.core.selected[r]].parents);
                                for (s = e.vakata.array_unique(s),
                                r = 0,
                                n = s.length; n > r; r++)
                                    this.open_node(s[r], !1, 0)
                            }
            ...
            get_node: function(t, i) {
                ...
                try {
                    ...
                    else if (((s = e(t, this.element)).length || (s = e("#" + t.replace(e.jstree.idregex, "\\$&"), this.element)).length) && this._model.data[s.closest(".jstree-node").attr("id")])
                        t = this._model.data[s.closest(".jstree-node").attr("id")];
                    else {
                        if (!(s = e(t, this.element)).length || !s.hasClass("jstree"))
                            return !1;
                        t = this._model.data["#"]
                    }
            ...
            get_path: function(e, t, i) {
                ...
                s = 0,
                r = e.parents.length; r > s; s++)
                    n.push(i ? e.parents[s] : this.get_text(e.parents[s]));
            ...
            get_next_dom: function(t, i) {
                ...
                t[0] === this.element[0] ? (s = this._firstChild(this.get_container_ul()[0]),
                s ? e(s) : !1) : t && t.length ? i ? (s = this._nextSibling(t[0]),
                s ? e(s) : !1) : t.hasClass("jstree-open") ? (s = this._firstChild(t.children(".jstree-children")[0]),
                s ? e(s) : !1) : null  !== (s = this._nextSibling(t[0])) ? e(s) : t.parentsUntil(".jstree", ".jstree-node").next(".jstree-node").eq(0) : !1
            },
            get_prev_dom: function(t, i) {
                var s;
                if (t = this.get_node(t, !0),
                t[0] === this.element[0])
                    return s = this.get_container_ul()[0].lastChild,
                    s ? e(s) : !1;
                if (!t || !t.length)
                    return !1;
                if (i)
                    return s = this._previousSibling(t[0]),
                    s ? e(s) : !1;
                if (null  !== (s = this._previousSibling(t[0]))) {
                    t = e(s);
                    while (t.hasClass("jstree-open"))
                        t = t.children(".jstree-children:eq(0)").children(".jstree-node:last");
                    return t
                }
            ...
            load_node: function(t, i) {
                ...
                if (t.state.loaded) {
                    ...
                    s = 0,
                    r = t.children_d.length; r > s; s++) {
                        for (n = 0,
                        a = t.parents.length; a > n; n++)
                            this._model.data[t.parents[n]].children_d = e.vakata.array_remove_item(this._model.data[t.parents[n]].children_d, t.children_d[s]);
                        this._model.data[t.children_d[s]].state.selected && (d = !0,
                        this._data.core.selected = e.vakata.array_remove_item(this._data.core.selected, t.children_d[s])),
            ...
            _load_nodes: function(e, t, i) {
                ...
                for (a = 0,
                d = e.length; d > a; a++)
                    !n[e[a]] || n[e[a]].state.loaded && i || (this.is_loading(e[a]) || this.load_node(e[a], r),
                    s = !1);
                s && t && !t.done && (t.call(this, e),
                t.done = !0)
            },
            _load_node: function(t, i) {
                ...
                return s ? e.isFunction(s) ? s.call(this, t, e.proxy(function(s) {
                    s === !1 && i.call(this, !1),
                    this["string" == typeof s ? "_append_html_data" : "_append_json_data"](t, "string" == typeof s ? e(s) : s, function(e) {
                        i.call(this, e)
                    }
                    )
                }
                , this)) : "object" == typeof s ? s.url ? (s = e.extend(!0, {}, s),
                e.isFunction(s.url) && (s.url = s.url.call(this, t)),
                e.isFunction(s.data) && (s.data = s.data.call(this, t)),
                e.ajax(s).done(e.proxy(function(s, r, n) {
                ...
                , this))) : (r = e.isArray(s) || e.isPlainObject(s) ? JSON.parse(JSON.stringify(s)) : s,
                "#" === t.id ? this._append_json_data(t, r, function(e) {
                    i.call(this, e)
                }
                ) : (this._data.core.last_error = {
                    error: "nodata",
                ...
                this.settings.core.error.call(this, this._data.core.last_error),
                i.call(this, !1))) : "string" == typeof s ? "#" === t.id ? this._append_html_data(t, e(s), function(e) {
                    i.call(this, e)
                }
                ) : (this._data.core.last_error = {
                    error: "nodata",
            ...
            _append_json_data: function(t, i, s) {
                ...
                var r = null 
                  ...
                  , a = function(e, t) {
                    ...
                    var i = e.dat, s = e.par, r = [], n = [], a = [], d = e.df, o = e.t_id, c = e.t_cnt, l = e.m, h = l[s], _ = e.sel, u, g, f, p, m = function(e, i, s) {
                        ...
                        if (_.li_attr.id || (_.li_attr.id = r),
                    ...
                    if (i.length && i[0].id !== t && i[0].parent !== t) {
                        ...
                        f = h.children.length; f > g; g++)
                            u = m(l[h.children[g]], s, h.parents.concat()),
                            n.push(u),
                  ...
                  , d = function(t, i) {
                    ...
                    i) {
                        ...
                        if (d.length !== o.length || e.vakata.array_unique(d.concat(o)).length !== d.length) {
                            for (r = 0,
                            n = d.length; n > r; r++)
                                -1 === e.inArray(d[r], a) && -1 === e.inArray(d[r], o) && (c[d[r]].state.selected = !1);
                            for (r = 0,
                            n = o.length; n > r; r++)
                                -1 === e.inArray(o[r], d) && (c[o[r]].state.selected = !0)
                        }
                    }
                ...
                if (this.settings.core.worker && window.Blob && window.URL && window.Worker)
                    try {
                        ...
                        r.onmessage = e.proxy(function(e) {
                            d.call(this, e.data, !0),
                            this._data.core.working = !1,
                            this._data.core.worker_queue.length && this._append_json_data.apply(this, this._data.core.worker_queue.shift())
                        }
                        , this),
                        this._data.core.working ? this._data.core.worker_queue.push([t, i, s]) : (this._data.core.working = !0,
                        r.postMessage(n))
                    } catch (o) {
                        d.call(this, a(n), !1)
                    }
            ...
            _parse_model_from_html: function(i, s, r) {
                ...
                e.each(l, function(i, s) {
                    return s = e.trim(s),
                    s.length ? (o.li_attr[i] = s,
                    "id" === i && (o.id = "" + s),
                    t) : !0
                }
                ),
                ...
                l = i.children("a:eq(0)").length ? i.children("a:eq(0)").clone() : i.clone(),
            ...
            _parse_model_from_flat_json: function(e, i, s) {
                ...
                if (h.li_attr.id || (h.li_attr.id = r),
                e && "object" == typeof e.a_attr)
                    for (d in e.a_attr)
                ...
                o = h.children.length; o > d; d++)
                    c = this._parse_model_from_flat_json(n[h.children[d]], h.id, s),
                    l = n[c],
                    h.children_d.push(c),
            ...
            _parse_model_from_json: function(e, i, s) {
                ...
                if (e && e.children && e.children.length) {
                    ...
                    a = e.children.length; a > n; n++)
                        d = this._parse_model_from_json(e.children[n], h.id, s),
                        o = c[d],
                        h.children.push(d),
            ...
            _redraw: function() {
                var e = this._model.force_full_redraw ? this._model.data["#"].children.concat([]) : this._model.changed.concat([]), t = document.createElement("UL"), i, s, r;
                for (s = 0,
                r = e.length; r > s; s++)
                    i = this.redraw_node(e[s], !0, this._model.force_full_redraw),
            ...
            redraw_node: function(t, i, s) {
                ...
                if (i = i || 0 === r.children.length,
                t = document.querySelector ? this.element[0].querySelector("#" + (-1 !== "0123456789".indexOf(r.id[0]) ? "\\3" + r.id[0] + " " + r.id.substr(1).replace(e.jstree.idregex, "\\$&") : r.id.replace(e.jstree.idregex, "\\$&"))) : document.getElementById(r.id))
                    t = e(t),
                    s || (n = t.parent().parent()[0],
                    n === this.element[0] && (n = null ),
                    a = t.index()),
                ...
                !s) {
                    if (n = "#" !== r.parent ? e("#" + r.parent.replace(e.jstree.idregex, "\\$&"), this.element)[0] : null ,
                    !(null  === n || n && g[r.parent].state.opened))
                        return !1;
                ...
                for (o in r.li_attr)
                    if (r.li_attr.hasOwnProperty(o)) {
                        if ("id" === o)
                            continue;"class" !== o ? t.setAttribute(o, r.li_attr[o]) : _ += r.li_attr[o]
                    }
                p && "false" !== p && t.setAttribute("aria-selected", !0),
                r.state.loaded && !r.children.length ? _ += " jstree-leaf" : (_ += r.state.opened && r.state.loaded ? " jstree-open" : " jstree-closed",
                t.setAttribute("aria-expanded", r.state.opened && r.state.loaded)),
                ...
                for (l in r.a_attr)
                    if (r.a_attr.hasOwnProperty(l)) {
                        if ("href" === l && "#" === r.a_attr[l])
                            continue;"class" !== l ? t.childNodes[1].setAttribute(l, r.a_attr[l]) : _ += " " + r.a_attr[l]
                    }
                if (_.length && (t.childNodes[1].className = "jstree-anchor " + _),
                (r.icon && r.icon !== !0 || r.icon === !1) && (r.icon === !1 ? t.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden" : -1 === r.icon.indexOf("/") && -1 === r.icon.indexOf(".") ? t.childNodes[1].childNodes[0].className += " " + r.icon + " jstree-themeicon-custom" : (t.childNodes[1].childNodes[0].style.backgroundImage = "url(" + r.icon + ")",
                ...
                this.settings.core.force_text ? t.childNodes[1].appendChild(u.createTextNode(r.text)) : t.childNodes[1].innerHTML += r.text,
                i && r.children.length && r.state.opened && r.state.loaded) {
                    for (h = u.createElement("UL"),
                    h.setAttribute("role", "group"),
                    h.className = "jstree-children",
                    o = 0,
                    l = r.children.length; l > o; o++)
                        h.appendChild(this.redraw_node(r.children[o], i, !0));
                    t.appendChild(h)
                }
                ...
                return r.state.opened && !r.state.loaded && (r.state.opened = !1,
                setTimeout(e.proxy(function() {
            ...
            open_node: function(i, s, r) {
                ...
                if (e.isArray(i)) {
                    ...
                    n = 0,
                    a = i.length; a > n; n++)
                        this.open_node(i[n], s, r);
                    return !0
                }
                if (i = this.get_node(i),
                !i || "#" === i.id)
                    return !1;
                if (r = r === t ? this.settings.core.animation : r,
                !this.is_closed(i))
                    return s && s.call(this, i, !1),
                    !1;
                if (this.is_loaded(i))
                    d = this.get_node(i, !0),
                    o = this,
                    d.length && (i.children.length && !this._firstChild(d.children(".jstree-children")[0]) && (i.state.opened = !0,
            ...
            close_node: function(i, s) {
                ...
                if (e.isArray(i)) {
                    ...
                    r = 0,
                    n = i.length; n > r; r++)
                        this.close_node(i[r], s);
                    return !0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? this.is_closed(i) ? !1 : (s = s === t ? this.settings.core.animation : s,
                a = this,
                d = this.get_node(i, !0),
                d.length && (s ? d.children(".jstree-children").attr("style", "display:block !important").end().removeClass("jstree-open").addClass("jstree-closed").attr("aria-expanded", !1).children(".jstree-children").stop(!0, !0).slideUp(s, function() {
                    this.style.display = "",
            ...
            enable_node: function(i) {
                ...
                if (e.isArray(i)) {
                    ...
                    s = 0,
                    r = i.length; r > s; s++)
                        this.enable_node(i[s]);
                    return !0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (i.state.disabled = !1,
                this.get_node(i, !0).children(".jstree-anchor").removeClass("jstree-disabled"),
            ...
            disable_node: function(i) {
                ...
                if (e.isArray(i)) {
                    ...
                    s = 0,
                    r = i.length; r > s; s++)
                        this.disable_node(i[s]);
                    return !0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (i.state.disabled = !0,
                this.get_node(i, !0).children(".jstree-anchor").addClass("jstree-disabled"),
            ...
            dehover_node: function(e) {
                return e = this.get_node(e, !0),
                e && e.length && e.children(".jstree-hovered").length ? (e.attr("aria-selected", !1).children(".jstree-anchor").removeClass("jstree-hovered"),
            ...
            select_node: function(i, s, r, n) {
                ...
                r || (a = this._open_to(i)),
                a && a.length && a.children(".jstree-anchor").addClass("jstree-clicked"),
            ...
            deselect_node: function(i, s, r) {
                ...
                d.length && d.children(".jstree-anchor").removeClass("jstree-clicked"),
            ...
            select_all: function(e) {
                ...
                i = 0,
                s = this._data.core.selected.length; s > i; i++)
            ...
            get_top_selected: function(t) {
                ...
                n = i.length; n > r; r++)
                    for (a = 0,
                    d = i[r].children_d.length; d > a; a++)
                        s[i[r].children_d[a]] && delete s[i[r].children_d[a]];
                i = [];
                for (r in s)
                    s.hasOwnProperty(r) && i.push(r);
            ...
            get_bottom_selected: function(t) {
                ...
                for (r = 0,
                n = i.length; n > r; r++)
                    i[r].children.length || s.push(i[r].id);
            ...
            set_state: function(i, s) {
                if (i) {
                    if (i.core) {
                        var r, n, a, d;
                        if (i.core.open)
                            return e.isArray(i.core.open) ? (r = !0,
                            n = !1,
                            a = this,
                            e.each(i.core.open.concat([]), function(t, d) {
                                n = a.get_node(d),
                                n && (a.is_loaded(d) ? (a.is_closed(d) && a.open_node(d, !1, 0),
                                i && i.core && i.core.open && e.vakata.array_remove_item(i.core.open, d)) : (a.is_loading(d) || a.open_node(d, e.proxy(function(t, r) {
                                    !r && i && i.core && i.core.open && e.vakata.array_remove_item(i.core.open, t.id),
                                    this.set_state(i, s)
                                }
                                , a), 0),
                                r = !1))
            ...
            refresh: function(t, i) {
                ...
                this.load_node("#", function(t, i) {
                    i && (this.get_container_ul()[0].className = s,
            ...
            set_id: function(t, i) {
                ...
                s = 0,
                r = t.parents.length; r > s; s++)
                    n[t.parents[s]].children_d[e.inArray(t.id, n[t.parents[s]].children_d)] = i;
                for (s = 0,
                r = t.children.length; r > s; s++)
                    n[t.children[s]].parent = i;
                for (s = 0,
                r = t.children_d.length; r > s; s++)
                    n[t.children_d[s]].parents[e.inArray(t.id, n[t.children_d[s]].parents)] = i;
            ...
            get_json: function(e, t, i) {
                ...
                if (t && t.flat ? s.parent = e.parent : s.children = [],
                !t || !t.no_state)
                    for (r in e.state)
                        e.state.hasOwnProperty(r) && (s.state[r] = e.state[r]);
                if (t && t.no_id && (delete s.id,
                s.li_attr && s.li_attr.id && delete s.li_attr.id),
                t && t.flat && "#" !== e.id && i.push(s),
                !t || !t.no_children)
                    for (r = 0,
                    n = e.children.length; n > r; r++)
                        t && t.flat ? this.get_json(e.children[r], t, i) : s.children.push(this.get_json(e.children[r], t));
            ...
            create_node: function(i, s, r, n, a) {
                ...
                !i)
                    return !1;
                if (r = r === t ? "last" : r,
                !("" + r).match(/^(before|after)$/) && !a && !this.is_loaded(i))
                ...
                if (r > i.children.length && (r = i.children.length),
                s.id || (s.id = !0),
                !this.check("create_node", s, i, r))
                    return this.settings.core.error.call(this, this._data.core.last_error),
                    !1;
                if (s.id === !0 && delete s.id,
                s = this._parse_model_from_json(s, i.id, i.parents.concat()),
                !s)
                    return !1;
                for (d = this.get_node(s),
                o = [],
                o.push(s),
            ...
            delete_node: function(t) {
                ...
                !t || "#" === t.id)
                    return !1;
                if (r = this.get_node(t.parent),
                n = e.inArray(t.id, r.children),
                h = !1,
                !this.check("delete_node", t, r, n))
                    return this.settings.core.error.call(this, this._data.core.last_error),
                    !1;
                for (-1 !== n && (r.children = e.vakata.array_remove(r.children, n)),
            ...
            check: function(t, i, s, r, n) {
                ...
                return "move_node" !== t && "copy_node" !== t || n && n.is_multi || i.id !== s.id && e.inArray(i.id, s.children) !== r && -1 === e.inArray(s.id, i.children_d) ? (a && a.data && (a = a.data),
            ...
            move_node: function(i, s, r, n, a) {
                ...
                if (s = this.get_node(s),
                r = r === t ? 0 : r,
                !s)
                    return !1;
                if (!("" + r).match(/^(before|after)$/) && !a && !this.is_loaded(s))
                    return this.load_node(s, function() {
                        this.move_node(i, s, r, n, !0)
                    }
                    );
                if (e.isArray(i)) {
                    for (i = i.reverse().slice(),
                    d = 0,
                    o = i.length; o > d; d++)
                        this.move_node(i[d], s, r, n, a);
                    return !0
                }
                ...
                !i || "#" === i.id)
                    return !1;
                if (c = "" + (i.parent || "#"),
                h = ("" + r).match(/^(before|after)$/) && "#" !== s.id ? this.get_node(s.parent) : s,
                _ = i.instance ? i.instance : this._model.data[i.id] ? this : e.jstree.reference(i.id),
                u = !_ || !_._id || this._id !== _._id,
                l = _ && _._id && c && _._model.data[c] && _._model.data[c].children ? e.inArray(i.id, _._model.data[c].children) : -1,
                u)
                    return this.copy_node(i, s, r, n, a) ? (_ && _.delete_node(i),
                    !0) : !1;
                switch ("#" === h.id && ("before" === r && (r = "first"),
                "after" === r && (r = "last")),
                r) {
                case "before":
                ...
                if (r > h.children.length && (r = h.children.length),
                !this.check("move_node", i, h, r, {
                    core: !0,
                    ...
                    !1;
                if (i.parent === h.id) {
                    for (g = h.children.concat(),
                    f = e.inArray(i.id, g),
                    -1 !== f && (g = e.vakata.array_remove(g, f),
                    r > f && r--),
                    f = [],
                    p = 0,
                    m = g.length; m > p; p++)
                    ...
                    for (f = i.children_d.concat(),
                    f.push(i.id),
                    p = 0,
                    m = i.parents.length; m > p; p++) {
                        for (g = [],
                        k = _._model.data[i.parents[p]].children_d,
                        v = 0,
                        j = k.length; j > v; v++)
                            -1 === e.inArray(k[v], f) && g.push(k[v]);
                        _._model.data[i.parents[p]].children_d = g
                    }
                    for (_._model.data[c].children = e.vakata.array_remove_item(_._model.data[c].children, i.id),
                    p = 0,
                    m = h.parents.length; m > p; p++)
                        this._model.data[h.parents[p]].children_d = this._model.data[h.parents[p]].children_d.concat(f);
                    for (g = [],
                    p = 0,
                    m = h.children.length; m > p; p++)
                        g[p >= r ? p + 1 : p] = h.children[p];
                    for (g[r] = i.id,
                    h.children = g,
                    h.children_d.push(i.id),
                    h.children_d = h.children_d.concat(i.children_d),
                    i.parent = h.id,
                    f = h.parents.concat(),
                    f.unshift(h.id),
                    k = i.parents.length,
                    ...
                    f = f.concat(),
                    p = 0,
                    m = i.children_d.length; m > p; p++)
                        this._model.data[i.children_d[p]].parents = this._model.data[i.children_d[p]].parents.slice(0, -1 * k),
            ...
            copy_node: function(i, s, r, n, a) {
                ...
                if (r > f.children.length && (r = f.children.length),
                !this.check("copy_node", i, f, r, {
                    core: !0,
                ...
                u = this._parse_model_from_json(u, f.id, f.parents.concat()),
                !u)
                    return !1;
                for (l = this.get_node(u),
                i && i.state && i.state.loaded === !1 && (l.state.loaded = !1),
                c = [],
                c.push(u),
                ...
                h = 0,
                _ = f.parents.length; _ > h; h++)
                    this._model.data[f.parents[h]].children_d = this._model.data[f.parents[h]].children_d.concat(c);
                for (c = [],
                h = 0,
                _ = f.children.length; _ > h; h++)
                    c[h >= r ? h + 1 : h] = f.children[h];
                return c[r] = l.id,
                f.children = c,
            ...
            set_icon: function(t, i) {
                ...
                i === !1 ? this.hide_icon(t) : i === !0 ? n.removeClass("jstree-themeicon-custom " + a).css("background", "").removeAttr("rel") : -1 === i.indexOf("/") && -1 === i.indexOf(".") ? (n.removeClass(a).css("background", ""),
            ...
            show_icon: function(t) {
                ...
                return t = this.get_node(t),
                t && "#" !== t ? (r = this.get_node(t, !0),
                t.icon = r.length ? r.children(".jstree-anchor").children(".jstree-themeicon").attr("rel") : !0,
                t.icon || (t.icon = !0),
        ...
        e.jstree.plugins.checkbox = function(i, s) {
            this.bind = function() {
                ...
                this.settings.checkbox.tie_selection || this.element.on("model.jstree", e.proxy(function(e, t) {
                    ...
                    for (n = 0,
                    a = r.length; a > n; n++)
                        i[r[n]].state.checked = i[r[n]].original && i[r[n]].original.state && i[r[n]].original.state.checked,
                ...
                (-1 !== this.settings.checkbox.cascade.indexOf("up") || -1 !== this.settings.checkbox.cascade.indexOf("down")) && this.element.on("model.jstree", e.proxy(function(t, i) {
                    ...
                    if (-1 !== u.indexOf("down"))
                        if (r.state[g ? "selected" : "checked"]) {
                            for (o = 0,
                            c = n.length; c > o; o++)
                                s[n[o]].state[g ? "selected" : "checked"] = !0;
                            ...
                            c = n.length; c > o; o++)
                                if (s[n[o]].state[g ? "selected" : "checked"]) {
                                    for (l = 0,
                                    h = s[n[o]].children_d.length; h > l; l++)
                                        s[s[n[o]].children_d[l]].state[g ? "selected" : "checked"] = !0;
                                    this._data[g ? "core" : "checkbox"].selected = this._data[g ? "core" : "checkbox"].selected.concat(s[n[o]].children_d)
                                }
                    if (-1 !== u.indexOf("up")) {
                        for (o = 0,
                        c = r.children_d.length; c > o; o++)
                            s[r.children_d[o]].children.length || a.push(s[r.children_d[o]].parent);
                        ...
                        h = a.length; h > l; l++) {
                            ...
                            while (r && "#" !== r.id) {
                                for (d = 0,
                                o = 0,
                                c = r.children.length; c > o; o++)
                                    d += s[r.children[o]].state[g ? "selected" : "checked"];
                                if (d !== c)
                                    break;
                ...
                , this)).on(this.settings.checkbox.tie_selection ? "select_node.jstree" : "check_node.jstree", e.proxy(function(t, i) {
                    ...
                    if (-1 !== h.indexOf("down"))
                        for (this._data[_ ? "core" : "checkbox"].selected = e.vakata.array_unique(this._data[_ ? "core" : "checkbox"].selected.concat(s.children_d)),
                        d = 0,
                        o = s.children_d.length; o > d; d++)
                            l = r[s.children_d[d]],
                    ...
                    if (-1 !== h.indexOf("up"))
                        while (n && "#" !== n.id) {
                            ...
                            o = n.children.length; o > d; d++)
                                c += r[n.children[d]].state[_ ? "selected" : "checked"];
                            if (c !== o)
                                break;
                ...
                , this)).on(this.settings.checkbox.tie_selection ? "deselect_node.jstree" : "uncheck_node.jstree", e.proxy(function(t, i) {
                    ...
                    if (s && s.original && s.original.state && s.original.state.undetermined && (s.original.state.undetermined = !1),
                    -1 !== o.indexOf("down"))
                        for (n = 0,
                        a = s.children_d.length; a > n; n++)
                            d = this._model.data[s.children_d[n]],
                            d.state[c ? "selected" : "checked"] = !1,
                            d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1);
                    if (-1 !== o.indexOf("up"))
                        for (n = 0,
                        a = s.parents.length; a > n; n++)
                            d = this._model.data[s.parents[n]],
                            d.state[c ? "selected" : "checked"] = !1,
                            d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1),
                    ...
                    a = this._data[c ? "core" : "checkbox"].selected.length; a > n; n++)
                        -1 !== o.indexOf("down") && -1 !== e.inArray(this._data[c ? "core" : "checkbox"].selected[n], s.children_d) || -1 !== o.indexOf("up") && -1 !== e.inArray(this._data[c ? "core" : "checkbox"].selected[n], s.parents) || d.push(this._data[c ? "core" : "checkbox"].selected[n]);
                ...
                -1 !== this.settings.checkbox.cascade.indexOf("up") && this.element.on("delete_node.jstree", e.proxy(function(e, t) {
                    ...
                    while (i && "#" !== i.id) {
                        for (a = 0,
                        r = 0,
                        n = i.children.length; n > r; r++)
                            a += s[i.children[r]].state[o ? "selected" : "checked"];
                        if (a !== n)
                            break;
            ...
            this._undetermined = function() {
                ...
                for (t = 0,
                i = n.length; i > t; t++)
                    s[n[t]] && s[n[t]].parents && (a = a.concat(s[n[t]].parents));
                for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function() {
                    ...
                    if (e.state.loaded)
                        ...
                        i = e.children_d.length; i > t; t++)
                            r = s[e.children_d[t]],
                            !r.state.loaded && r.original && r.original.state && r.original.state.undetermined && r.original.state.undetermined === !0 && (a.push(r.id),
                            a = a.concat(r.parents));
                    else
                ...
                t = 0,
                i = a.length; i > t; t++)
                    s[a[t]].state[r ? "selected" : "checked"] || (n = this.get_node(a[t], !0),
            ...
            this.redraw_node = function(t, i, r) {
                if (t = s.redraw_node.call(this, t, i, r)) {
                    ...
                    d.insertBefore(_.cloneNode(!1), d.childNodes[0]))
                }
            ...
            this.is_undetermined = function(t) {
                ...
                for (s = 0,
                r = t.children_d.length; r > s; s++)
                    if (-1 !== e.inArray(t.children_d[s], a) || !d[t.children_d[s]].state.loaded && d[t.children_d[s]].original.state.undetermined)
                        return !0;
                return !1
            }
            ,
            this.activate_node = function(i, r) {
                ...
                this.settings.checkbox.tie_selection || !this.settings.checkbox.whole_node && !e(r.target).hasClass("jstree-checkbox") ? s.activate_node.call(this, i, r) : (this.is_checked(i) ? this.uncheck_node(i, r) : this.check_node(i, r),
                this.trigger("activate_node", {
                    node: this.get_node(i)
                }),
                t)
            ...
            this.check_node = function(i, s) {
                if (this.settings.checkbox.tie_selection)
                    return this.select_node(i, !1, !0, s);
                var r, n, a, d;
                if (e.isArray(i)) {
                    for (i = i.slice(),
                    n = 0,
                    a = i.length; a > n; n++)
                        this.check_node(i[n], s);
                    return !0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (r = this.get_node(i, !0),
            ...
            this.uncheck_node = function(i, s) {
                if (this.settings.checkbox.tie_selection)
                    return this.deselect_node(i, !1, s);
                var r, n, a;
                if (e.isArray(i)) {
                    for (i = i.slice(),
                    r = 0,
                    n = i.length; n > r; r++)
                        this.uncheck_node(i[r], s);
                    return !0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (a = this.get_node(i, !0),
        ...
        e.jstree.plugins.contextmenu = function(i, s) {
            ...
            this.show_contextmenu = function(i, s, r, n) {
                ...
                var a = this.settings.contextmenu
                  ...
                  , c = !1
                  , l = !1;
                (a.show_at_node || s === t || r === t) && (c = o.offset(),
                s = c.left,
        ...
        function(e) {
            ...
            e.vakata.context = {
                ...
                _parse: function(i, r) {
                    ...
                    e.each(i, function(i, r) {
                        return r ? (s.items.push(r),
                        !a && r.separator_before && (n += "<li class='vakata-context-separator'><a href='#' " + (e.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;<" + "/a><" + "/li>"),
                        a = !1,
                        n += "<li class='" + (r._class || "") + (r._disabled === !0 || e.isFunction(r._disabled) && r._disabled({
                            item: r,
                            reference: s.reference,
                            element: s.element
                        }) ? " vakata-contextmenu-disabled " : "") + "' " + (r.shortcut ? " data-shortcut='" + r.shortcut + "' " : "") + ">",
                        n += "<a href='#' rel='" + (s.items.length - 1) + "'>",
                        e.vakata.context.settings.icons && (n += "<i ",
                        r.icon && (n += -1 !== r.icon.indexOf("/") || -1 !== r.icon.indexOf(".") ? " style='background:url(\"" + r.icon + "\") center center no-repeat' " : " class='" + r.icon + "' "),
                        n += "></i><span class='vakata-contextmenu-sep'>&#160;</span>"),
                        n += (e.isFunction(r.label) ? r.label({
                            item: i,
                            reference: s.reference,
                            element: s.element
                        }) : r.label) + (r.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + r.shortcut + '">' + (r.shortcut_label || "") + "</span>" : "") + "<" + "/a>",
                        r.submenu && (d = e.vakata.context._parse(r.submenu, !0),
                        d && (n += d)),
                        n += "</li>",
                        r.separator_after && (n += "<li class='vakata-context-separator'><a href='#' " + (e.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') + ">&#160;<" + "/a><" + "/li>",
                        a = !0),
                        t) : !0
                    }
                    ),
                ...
                show: function(t, r, n) {
                    ...
                    switch (s.element && s.element.length && s.element.width(""),
                    g) {
                    case !r && !t:
                        return !1;
                    case !!r && !!t:
                ...
                hide: function() {
                    s.is_visible && (s.element.hide().find("ul").hide().end().find(":focus").blur(),
                    s.is_visible = !1,
            ...
            e(function() {
                ...
                s.element.on("mouseenter", "li", function(i) {
                    i.stopImmediatePropagation(),
                    e.contains(this, i.relatedTarget) || (t && clearTimeout(t),
                    s.element.find(".vakata-context-hover").removeClass("vakata-context-hover").end(),
                    ...
                    case 32:
                        ...
                        break;
                    case 37:
                        s.is_visible && (s.element.find(".vakata-context-hover").last().parents("li:eq(0)").find("ul").hide().find(".vakata-context-hover").removeClass("vakata-context-hover").end().end().children("a").focus(),
                        t.stopImmediatePropagation(),
                        t.preventDefault());
                        break;
                    case 38:
                        s.is_visible && (i = s.element.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").prevAll("li:not(.vakata-context-separator)").first(),
                        i.length || (i = s.element.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").last()),
                        i.addClass("vakata-context-hover").children("a").focus(),
                        t.stopImmediatePropagation(),
                        t.preventDefault());
                        break;
                    case 39:
                        s.is_visible && (s.element.find(".vakata-context-hover").last().children("ul").show().children("li:not(.vakata-context-separator)").removeClass("vakata-context-hover").first().addClass("vakata-context-hover").children("a").focus(),
                        t.stopImmediatePropagation(),
                        t.preventDefault());
                        break;
                    case 40:
                        s.is_visible && (i = s.element.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").nextAll("li:not(.vakata-context-separator)").first(),
                        i.length || (i = s.element.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").first()),
                        i.addClass("vakata-context-hover").children("a").focus(),
                        t.stopImmediatePropagation(),
                        t.preventDefault());
                        break;
        ...
        e.jstree.plugins.dnd = function(i, s) {
            this.bind = function() {
                ...
                this.element.on("mousedown.jstree touchstart.jstree", ".jstree-anchor", e.proxy(function(i) {
                    ...
                    return s && s.id && "#" !== s.id && (1 === i.which || "touchstart" === i.type) && (this.settings.dnd.is_draggable === !0 || e.isFunction(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, r > 1 ? this.get_selected(!0) : [s])) ? (this.element.trigger("mousedown.jstree"),
        ...
        e(function() {
            ...
            e(document).bind("dnd_start.vakata", function(e, t) {
                    ...
                    if (o && o._data && o._data.dnd)
                        ...
                        d.event.target !== o.element[0] && d.event.target !== o.get_container_ul()[0] || 0 !== o.get_container_ul().children().length) {
                            ...
                            e.each(m, function(a, h) {
                                ...
                                for (v = !0,
                                j = 0,
                                k = d.data.nodes.length; k > j; j++)
                                    if (y = d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "copy_node" : "move_node",
                                    x = p,
                                    "move_node" === y && "a" === h && d.data.origin && d.data.origin === o && f === o.get_parent(d.data.nodes[j]) && (b = o.get_node(f),
                                    x > e.inArray(d.data.nodes[j], b.children) && (x -= 1)),
                                    v = v && (o && o.settings && o.settings.dnd && o.settings.dnd.check_while_dragging === !1 || o.check(y, d.data.origin && d.data.origin !== o ? d.data.origin.get_node(d.data.nodes[j]) : d.data.nodes[j], f, x, {
                                        dnd: !0,
                ...
                i = !1,
                t.helper.find(".jstree-icon:eq(0)").removeClass("jstree-ok").addClass("jstree-er"))
            }
                ...
                a && a.data && a.data.jstree) {
                    ...
                    if (i) {
                        ...
                        d.length && s && s.error && "check" === s.error && (d = d.jstree(!0),
                        d && d.settings.core.error.call(this, s))
                }
            }
        ...
        function(e) {
            ...
            e.vakata.dnd = {
                ...
                _clean: function() {
                    ...
                    e(document).off("mousemove touchmove", e.vakata.dnd.drag),
                    e(document).off("mouseup touchend", e.vakata.dnd.stop)
                },
                _scroll: function(t) {
                ...
                start: function(t, s, r) {
                    ...
                    e(document).bind("mousemove touchmove", e.vakata.dnd.drag),
                    e(document).bind("mouseup touchend", e.vakata.dnd.stop),
                    !1
                },
                drag: function(s) {
                    if ("touchmove" === s.type && s.originalEvent && s.originalEvent.changedTouches && s.originalEvent.changedTouches[0] && (s.pageX = s.originalEvent.changedTouches[0].pageX,
                    s.pageY = s.originalEvent.changedTouches[0].pageY,
                    s.target = document.elementFromPoint(s.originalEvent.changedTouches[0].pageX - window.pageXOffset, s.originalEvent.changedTouches[0].pageY - window.pageYOffset)),
                    i.is_down) {
                        if (!i.is_drag) {
                            if (!(Math.abs(s.pageX - i.init_x) > (i.is_touch ? e.vakata.dnd.settings.threshold_touch : e.vakata.dnd.settings.threshold) || Math.abs(s.pageY - i.init_y) > (i.is_touch ? e.vakata.dnd.settings.threshold_touch : e.vakata.dnd.settings.threshold)))
                                return;
                        ...
                        e(e(s.target).parentsUntil("body").addBack().get().reverse()).filter(function() {
                            ...
                            var r = e(this)
                              , n = r.offset();
                            return this.scrollHeight > this.offsetHeight && (n.top + r.height() - s.pageY < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = 1),
                            s.pageY - n.top < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = -1)),
                            this.scrollWidth > this.offsetWidth && (n.left + r.width() - s.pageX < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = 1),
                            s.pageX - n.left < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = -1)),
                            i.scroll_t || i.scroll_l ? (i.scroll_e = e(this),
                            !1) : t
                        }
                        ),
                        i.scroll_e || (r = e(document),
                        n = e(window),
                        a = r.height(),
                        d = n.height(),
                        o = r.width(),
                        ...
                        l = r.scrollTop(),
                        h = r.scrollLeft(),
                        a > d && s.pageY - l < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = -1),
                        a > d && d - (s.pageY - l) < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = 1),
                        o > c && s.pageX - h < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = -1),
                        o > c && c - (s.pageX - h) < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = 1),
                        (i.scroll_t || i.scroll_l) && (i.scroll_e = r)),
                        i.scroll_e && e.vakata.dnd._scroll(!0),
                        i.helper && (_ = parseInt(s.pageY + e.vakata.dnd.settings.helper_top, 10),
                        u = parseInt(s.pageX + e.vakata.dnd.settings.helper_left, 10),
                        a && _ + 25 > a && (_ = a - 50),
        ...
        e.jstree.plugins.search = function(i, s) {
            this.bind = function() {
                ...
                this.element.on("before_open.jstree", e.proxy(function(t, i) {
                    ...
                    this.settings.search.show_only_matches && this._data.search.res.length)) {
                        for (s = 0,
                        r = a.length; r > s; s++)
                            d = d.concat(this.get_node(a[s]).parents);
                ...
                , this)),
                this.settings.search.show_only_matches && this.element.on("search.jstree", function(t, i) {
            ...
            this.search = function(i, s) {
                ...
                e.each(this._model.data, function(e, t) {
                    t.text && (r.search_callback && r.search_callback.call(this, i, t) || !r.search_callback && a.search(t.text).isMatch) && (!r.search_leaves_only || t.state.loaded && 0 === t.children.length) && (d.push(e),
                    o = o.concat(t.parents))
                }
                ),
                d.length && (o = e.vakata.array_unique(o),
                this._search_open(o),
                this._data.search.dom = e(this.element[0].querySelectorAll("#" + e.map(d, function(t) {
                    return -1 !== "0123456789".indexOf(t[0]) ? "\\3" + t[0] + " " + t.substr(1).replace(e.jstree.idregex, "\\$&") : t.replace(e.jstree.idregex, "\\$&")
                }
                ).join(", #"))),
                ...
                n.data || (n.data = {}),
                n.data.str = i,
                e.ajax(n).fail(e.proxy(function() {
                    this._data.core.last_error = {
                        error: "ajax",
                        plugin: "search",
                        id: "search_01",
            ...
            this._search_open = function(t) {
                ...
                e.each(t.concat([]), function(s, r) {
                    ...
                    r && r.length && i.is_closed(r) && (i._data.search.opn.push(r[0].id),
                    i.open_node(r, function() {
                        i._search_open(t)
                    }
                    , 0))
                }
            ...
            e.vakata.search = function(e, t, i) {
                ...
                l = function(t) {
                    ...
                    r = 0; a > r; r++) {
                        ...
                        l = j; l >= v; l--)
                            if (y = o[t.charAt(l - 1)],
                            k[l] = 0 === r ? (1 | k[l + 1] << 1) & y : (1 | k[l + 1] << 1) & y | (1 | (m[l + 1] | m[l]) << 1) | m[l + 1],
                            k[l] & d && (x = c(r, l - 1),
                            _ >= x)) {
                                if (_ = x,
                                u = l - 1,
        ...
        e.jstree.plugins.state = function(t, i) {
            ...
            this.restore_state = function() {
                ...
                t ? (this.element.one("set_state.jstree", function(i, s) {
        ...
        e.jstree.plugins.types = function(i, s) {
                    ...
                    for (r in i.types)
                        if ("default" !== r && "#" !== r && i.types.hasOwnProperty(r))
                            for (n in i.types["default"])
                                i.types["default"].hasOwnProperty(n) && i.types[r][n] === t && (i.types[r][n] = i.types["default"][n]);
            ...
            this.check = function(i, r, n, a, d) {
                if (s.check.call(this, i, r, n, a, d) === !1)
                    return !1;
                ...
                case "copy_node":
                    if ("move_node" !== i || -1 === e.inArray(r.id, n.children)) {
                        ...
                        c.max_children !== t && -1 !== c.max_children && c.max_children === n.children.length)
                            ...
                            !1;
                        if (c.valid_children !== t && -1 !== c.valid_children && -1 === e.inArray(r.type, c.valid_children))
                            return this._data.core.last_error = {
                                error: "check",
                                plugin: "types",
                                id: "types_02",
                        ...
                        if (o && r.children_d && r.parents) {
                            for (l = 0,
                            h = 0,
                            _ = r.children_d.length; _ > h; h++)
                                l = Math.max(l, o[r.children_d[h]].parents.length);
            ...
            this.set_type = function(i, s) {
                ...
                o = this.get_icon(i),
                i.type = s,
                (o === !0 || r[d] && r[d].icon && o === r[d].icon) && this.set_icon(i, r[s].icon !== t ? r[s].icon : !0),
                !0) : !1
            }
        }
        ,
        ...
        e.jstree.plugins.unique = function(i, s) {
            this.check = function(t, i, r, n, a) {
                if (s.check.call(this, t, i, r, n, a) === !1)
                    return !1;
                if (i = i && i.id ? i : this.get_node(i),
                r = r && r.id ? r : this.get_node(r),
                !r || !r.children)
                ...
                for (h = 0,
                _ = r.children.length; _ > h; h++)
                    o.push(c ? l[r.children[h]].text : l[r.children[h]].text.toLowerCase());
        ...
        e.jstree.plugins.wholerow = function(t, i) {
            this.bind = function() {
                ...
                , this)).on("changed.jstree", e.proxy(function(e, t) {
                    ...
                    var i = !1, s, r;
                    for (s = 0,
                    r = t.selected.length; r > s; s++)
                        i = this.get_node(t.selected[s], !0),
