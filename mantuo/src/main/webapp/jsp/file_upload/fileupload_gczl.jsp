...
<div style="display:none;" class="myKeyValueDiv">
	...
	<input type="hidden" cond="true" condName="p_doc_uid">
	<input type="hidden" cond="true" condName="project_uid">
	...
	<input type="hidden" cond="true" condName="uploadType" value="gczl">
...
//----------------------------------------	
function setFileData(targetTable,targetCol,p_doc_uid,fileType,project_uid){
	var inputArr = $(".myKeyValueDiv input");
	...
	for(var xx=0;xx<inputArr.length;xx++){
		if(inputArr[xx].getAttribute("cond")=="true"){
			...
			}else if(inputArr[xx].getAttribute("condName")=="p_doc_uid"){
				inputArr[xx].value=p_doc_uid;
				
			}else if(inputArr[xx].getAttribute("condName")=="file_type"){
				inputArr[xx].value=fileType;
			}else if(inputArr[xx].getAttribute("condName")=="target_col"){
				inputArr[xx].value=targetCol;
			}else if(inputArr[xx].getAttribute("condName")=="project_uid"){
				inputArr[xx].value=project_uid;
			}
		}
	}
}
