...
<%
	String guifanuidstr = request.getParameter("guifanuidstr");
					...
					<div class="col-sm-9" >
						...
						<div class="modal-body">									    
					 	   <form method="post"  class="form-horizontal"  id="queryForm">
						  		...
						  		<input type="hidden" id="guifanuidstr" value="<%=guifanuidstr %>">
								<table  sortname="t.BZGF_UID" multiselect=false  rownum="10000" sortorder="ASC" class="auto_startgrid" id="grid_table" 
									...
									<tr>
										...
										<th name="NODE_CONTENT"  width="12" align="left">内容</th>
...
ace.load_ajax_scripts(scripts, function() {
	...
	var guifanuidstr1 = $("#guifanuidstr").val();
	
	if(guifanuidstr1!=""){
		selectContent = guifanuidstr1.split(","); //字符分割 
	}
