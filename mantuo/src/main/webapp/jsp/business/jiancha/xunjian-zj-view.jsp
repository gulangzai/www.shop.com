...
<div class="modal-dialog width-80 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看质量检查</h3>
  </div>
 	   ...
 	   <!-- 获取 项目 的 uid -->    	
      	 ...
      	 <input type="hidden" id="target_uid" fieldname="target_uid"  />
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					<input type="text" id="pName" datatype="*" class="col-xs-11 col-sm-11" >
				</div>	 
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<table  role="presentation" class="table table-striped">
						<tbody class="files showFileTab" data-toggle="modal-gallery" data-target="#modal-gallery" onlyView="true" file_type="10601"></tbody>
					</table>
				</div>
			</div>	
     </form>
...
function addWgnr(){
	var guifanuidstr = $("#guifanuidstr").val(); 
	window.open("${pageContext.request.contextPath }/jsp/business/jiancha/guifan-select2.jsp?guifanuidstr="+guifanuidstr);
}
