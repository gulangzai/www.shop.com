...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">添加质量检查标准</h3>
  </div>
  <div class="modal-body">
 	  ...
 	  <form method="post" role="form" class="form-horizontal"  id="executeFrm" > 
 	   <!-- 获取 项目 的 uid -->    	
      	 ...
      	 <input id="JIANCHA_TYPE" type="hidden" fieldname="JIANCHA_TYPE" value="ZJ" />
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input id="gfname" type="text" nullmsg = "请选择对应标准规范"  placeholder="请选择对应标准规范" class="col-xs-11 col-sm-11" disabled="disabled">
