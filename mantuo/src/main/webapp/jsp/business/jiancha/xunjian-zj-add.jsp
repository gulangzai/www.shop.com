...
<div class="modal-dialog width-80 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">添加质量检查</h3>
  </div>
  <div class="modal-body">
 	  ...
 	  <form method="post" role="form" class="form-horizontal"  id="executeFrm" > 
 	   <!-- 获取 项目 的 uid -->    	
      	 ...
      	 <input id="XUNJIAN_TYPE" type="hidden" fieldname="XUNJIAN_TYPE" value="ZJ" />
      	 ...
      	 <input type="hidden" id="guifanuidstr" />
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10" >
					<span class="col-xs-11 col-sm-11" id="tspan">
							...
							<table class="table table-striped table-bordered table-hover" id="ttable">
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea id="JIERUN"  datatype="*" nullmsg = "请输入检查结论"  placeholder="请输入检查结论" type="text"  fieldname="JIERUN" class="col-xs-11 col-sm-11" rows="5"></textarea>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input id="CANJIAN"  datatype="*" nullmsg = "请输入参建人员"  placeholder="请输入参建人员" type="text"  fieldname="CANJIAN" class="col-xs-11 col-sm-11" />
