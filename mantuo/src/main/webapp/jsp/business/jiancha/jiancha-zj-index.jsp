		    ...
		    <!-- form 开始 位置 -->
					<form class="form-inline"  id="queryForm" width="100%"
					   role="form" style="border:solid 1px #ddd;height:50px;line-height:50px;vertical-align:middle;">
						 <input type="hidden" id="JIANCHA_TYPE" value="ZJ" logic="and" fieldname="t.JIANCHA_TYPE" operation="=" fieldtype="text"> 
...
ace.load_ajax_scripts(scripts, function() {
	...
	//改变浏览器大小自适应
		...
		//权限检查
		checkBtnAuthority($("#project_uid").val(),$("#projectUserId").val(),"12050201","btn_new"); 
});
...
function updateXx(id){
	...
	$.get("${ctx}/jsp/business/jiancha/jiancha-zj-update.jsp",{
		"jc_uid":id
		},function(data){
		$("#jiancha-input").empty();
		$("#jiancha-input").html("");
...
function seeXx(id){
	...
	$.get("${ctx}/jsp/business/jiancha/jiancha-zj-view.jsp",{
		"jc_uid":id
		},function(data){
		$("#jiancha-input").empty();
		$("#jiancha-input").html("");
...
function goAdd(){
	...
	$.get("${ctx}/jsp/business/jiancha/jiancha-zj-add.jsp",
		{
