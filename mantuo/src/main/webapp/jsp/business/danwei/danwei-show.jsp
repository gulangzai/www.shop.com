...
<div class="modal-dialog width-40 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看单位</h3>
  </div>
  <div class="modal-body">
 	 <form method="post" role="form" class="form-horizontal"  id="executeFrm" >      	
		...
		<div class="form-group" >
			...
			<div class="col-sm-8">
				<input class="form-control" disabled="disabled" type="text"   id="COMPANY_NAMES" fieldname="COMPANY_NAME" datatype="*" nullmsg="请输入单位名称">
			</div>
		...
		<div class="form-group" >
			...
			<div class="col-sm-8">
				<input class="form-control" disabled="disabled"  type="text"  id="COMPANY_CODES" fieldname="COMPANY_CODE" datatype="*" nullmsg="请输入单位编号">
			</div>
		...
		<div class="form-group" >
			...
			<div class="col-sm-8">
				<input class="form-control" disabled="disabled" type="text"  id="LIANXI_RENS" fieldname="LIANXI_REN" datatype="*" nullmsg="请输入联系人">
			</div>
		...
		<div class="form-group" >
			...
			<div class="col-sm-8">
				<input class="form-control" disabled="disabled" type="text"  id="LIANXI_TELS" fieldname="LIANXI_TEL" datatype="/^[1][358][0-9]{9}$/" nullmsg="请输入联系电话">
			</div>
		...
		<div class="form-group" >
			...
			<div class="col-sm-8">
				<input class="form-control" disabled="disabled" type="text"  id="ADDRESSS" fieldname="ADDRESS" datatype="*" nullmsg="请输入单位地址">
			</div>
		...
		<div class="form-group" >
			...
			<div class="col-sm-8">
				<input class="form-control" disabled="disabled" type="text"  id="URLS" fieldname="URL" datatype="*" nullmsg="请输入单位网址">
			</div>
