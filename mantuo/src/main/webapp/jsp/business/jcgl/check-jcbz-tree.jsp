...
<div class="modal-dialog width-85 height-auto">
   ...
   <h3 id="dlixiangModalLabel" class="widget-title">模板信息</h3>
		...
		<div class="modal-body" id="proj_sel" >
             <div class="row">
						...
						<div class="col-xs-12"  style="padding-right: 0px">
						 ...
						 <div id="tableY" class="widget-box widget-color-grey">
						 <div class="widget-header" id="contentdivid2">
							...
							<table  sortname="xuhao" multiselect=false  rownum="10"
									...
									action="${pageContext.request.contextPath }/jcgl/sysBzjcController?queryTree&typeId=<%=id %>" >
								<tr>
