...
<%
 ...
 String TOOLS_UID = request.getParameter("TOOLS_UID");
 %>
<!-- Modal -->
<div class="modal-dialog width-70 height-auto">
  <div class="modal-content" >
   		<div class="widget-header widget-header-large">
    	<h3 id="myModalLabel" class="blue bigger">修改泵设备信息</h3>
  </div>
 	  ...
 	  <form method="post" role="form" class="form-horizontal"  id="executeFrm" > 
 	   <!-- 获取 项目 的 uid -->    	
      	 <input id="PROJECT_UID" type="hidden" name="PROJECT_UID" fieldname="PROJECT_UID" />
      	 	<input type="hidden"  kind="text" id="TOOLS_UID"  fieldname="TOOLS_UID" value="<%=TOOLS_UID%>" operation="="/>
   ...
   <!--可以再此处加入hidden域作为过滤条件 -->
   	<TR  style="display:none;">
     	<TD class="right-border bottom-border">
      	<INPUT type="text"  kind="text" id="TOOLS_UID"  fieldname="TOOLS_UID" value="<%=TOOLS_UID%>" operation="="/>
      	</TD>
		<TD class="right-border bottom-border">
		</TD>
     </TR>
