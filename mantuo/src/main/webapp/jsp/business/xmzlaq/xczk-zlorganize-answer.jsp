			          ...
			          <input type="hidden" fieldname="XIANCHANG_UID" value="<%=XC_UID %>" />
			           <input type="hidden" id="target_uid" fieldname="target_uid"  />										
							...
							<div class="form-group">
								<span class="col-sm-2" style="margin:0px;padding-right:0px;text-align:right;padding-left:12px;"  >
									附件信息：
								</span>
								<div class="col-sm-10">
									<span style="margin:4px auto;" class="btn  btn-white btn-default btn-round " onclick="selectFile(this);" file_type="10013" >
										<i class="ace-icon fa fa-cloud-upload bigger-100"></i>
											现场质量状况
									</span>
									<table  role="presentation" class="table table-striped">
										<tbody class="files showFileTab" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10013" fjlb="media"></tbody>
									</table>
								</div>
							</div>
				</form>
			...
			$.ajax({
				...
				success : function(response) {
				   if(response){
				       ...
				       theNewAnswer();
				       queryFileData('XIANCHANG_UID',"11111111111111");
