...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
   <div class="widget-header widget-header-large">
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看质量工况</h3>
  </div>
      	 ...
      	 <input id="XCJDROJECT_UID" type="hidden" name="ROJECT_UID" fieldname="PROJECT_UID"  />
	  	  ...
	  	  <input type="hidden" id="CREATES_USER" fieldname="CREATE_USER"/>	
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
				    <span>&nbsp;<input id="status" type="radio" disabled="disabled" name="STATUS" fieldname="STATUS"  value="-1" >&nbsp;草稿</span>
			...
			<div class="form-group" >
				...
				<div class="col-sm-4">
				 <input  id="FINISH_DATE" disabled="disabled" style="width: 80%;" class="col-xs-11 col-sm-11" data-date-format="yyyy-mm-dd"  datatype="*"  type="text"  fieldname="FINISH_DATE" />
				</div>
				<label class="col-sm-2 control-label no-padding-right" >
					严重性：
				</label>
				<div class="col-sm-4">
					 <select class="col-sm-4" id="SERIOUSNESS" disabled="disabled"   type="text"  fieldname="SERIOUSNESS">
            ...
            <label class="col-sm-2 control-label no-padding-right" >
				...
				<div class="col-sm-4">
				 <input  id="CLOSE_DATE" disabled="disabled" style="width: 80%;" class="col-xs-11 col-sm-11" data-date-format="yyyy-mm-dd"    type="text"  fieldname="CLOSE_DATE" />
				</div>
			</div>
     <%--文件类型及显示 上传文件 --%>
		<div class="form-group">
