...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
   <div class="widget-header widget-header-large">
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看安全工况</h3>
  </div>
      	 ...
      	 <input id="XCJDROJECT_UID" type="hidden" name="ROJECT_UID" fieldname="PROJECT_UID"  />
	  	  ...
	  	  <input type="hidden" id="CREATES_USER" fieldname="CREATE_USER"/>	
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
				  <span>   &nbsp;<input id="status" disabled="disabled" type="radio" name="STATUS" fieldname="STATUS"  value="-1" >&nbsp;草稿</span>
					&nbsp;<input id="jddoing" disabled="disabled" type="radio" name="STATUS" fieldname="STATUS"  value="0">&nbsp;解决中
					
					&nbsp;<input id="jdfinish" disabled="disabled" type="radio" name="STATUS" fieldname="STATUS"  value="1" >&nbsp;已解决
				</div>
			</div>
			...
			<!-- 
				...
				<div class="col-sm-4">
				 <input  id="FINISH_DATE" disabled="disabled" style="width: 80%;" class="col-xs-11 col-sm-11" data-date-format="yyyy-mm-dd"  datatype="*" nullmsg="请选择要求解决日期"   nullmsg="请选择要求解决日期"  placeholder="请选择要求完成日期" type="text"  fieldname="FINISH_DATE" />
				</div>
				<label class="col-sm-2 control-label no-padding-right" >
					严重性：
				</label>
            ...
            <div class="form-group">
				...
				<div class="col-sm-9">
					<table   role="presentation" class="table table-striped">
						<tbody onlyView="true" showType="width:120px;height:120px;quanxian:false;heightss:160px;heights:40px;del:false;attr:multi;preview:false;" class="files showFileTab" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10011" fjlb="media"></tbody>
					</table>
				</div>
		</div>
     </form>
