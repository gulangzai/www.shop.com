...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
   <div class="widget-header widget-header-large">
    	...
    	<h3 id="myModalLabel" class="blue bigger">修改质量工况</h3>
  </div>
 	  ...
 	  <form method="post" role="form" class="form-horizontal"  id="executeFrmXcJd" > 
 	   <!-- 获取 项目 的 uid -->    	
      	 <input id="XCJDROJECT_UID" type="hidden" name="ROJECT_UID" fieldname="PROJECT_UID"  />
	  	  ...
	  	  <!-- 
	  	   ...
	  	   <input type="hidden" id="STATUS" fieldname="STATUS" value=""/>
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					&nbsp;<input id="jddoing" type="radio" name="STATUS" value="0" fieldname="STATUS" >&nbsp;解决中
					
					&nbsp;<input id="jdfinish" type="radio" name="STATUS" value="1" fieldname="STATUS" >&nbsp;已解决
			...
			<!-- 
			 ...
			 -->	
				...
				<div class="col-sm-4">
				 <input  id="FINISH_DATE" autofocus="autofocus" data-date-format="yyyy-mm-dd"  datatype="*" nullmsg="请选择要求解决日期"  placeholder="请选择要求解决日期" type="text"  fieldname="FINISH_DATE"  class="col-xs-11 col-sm-11" />
				</div>
				<label class="col-sm-2 control-label no-padding-right" >
          ...
          <div class="form-group">
				...
				<div class="col-sm-9">
					<span id="xiugaFT" style="margin:4px auto;" class="btn  btn-white btn-default btn-round " onclick="selectFile(this);" file_type="10010" >
						<i class="ace-icon fa fa-cloud-upload bigger-100"></i>
							现场质量状况
					</span>
					<table  role="presentation" class="table table-striped">
						<tbody showType="width:120px;height:120px;heightss:160px;heights:40px;del:false;attr:multi;preview:false;" class="files showFileTab" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10010" fjlb="media"></tbody>
					</table>
				</div>
		  </div>
     </form>
  ...
  <button id="fabu"  class="btn btn-1 btn-sms" type="button">发布</button>
    ...
    <button id="btnCloseXczl"  class="btn btn-2 btn-sms pull-right" data-dismiss="modal" aria-hidden="true">关闭</button>
  </div>
</div>
</div>
