...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
   <div class="widget-header widget-header-large">
    	...
    	<h3 id="myModalLabel" class="blue bigger">修改文明施工</h3>
  </div>
          ...
          <div class="form-group">
				...
				<div class="col-sm-9">
					...
					<table  role="presentation" class="table table-striped">
						<tbody class="files showFileTab" showType="width:120px;height:120px;quanxian:true;heightss:160px;heights:40px;del:false;attr:multi;preview:false;" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10010" fjlb="media"></tbody>
					</table>
				</div>
		  </div>
     </form>
  ...
  <button id="tijiao" class="btn btn-1 btn-sms" type="button">解决</button>
    ...
    <button id="btnCloseXczl"  class="btn btn-2 btn-sms" data-dismiss="modal" aria-hidden="true">关闭</button>
  </div>
