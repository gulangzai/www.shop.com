...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看变更管理</h3>
  </div>
 	   ...
 	   <!-- 获取 项目 的 uid -->
	  	 ...
	  	 <input type="hidden" id="target_uid" fieldname="target_uid"  />	  	
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <input id="biangengDate22" disabled="disabled" class="col-xs-11 col-sm-11"  data-date-format="yyyy-mm-dd" datatype="*" nullmsg = "请输入日期"  placeholder="请输入日期" type="text"  fieldname="BIANGENG_DATE"  />
				</div>
				...
				<div class="col-sm-4">
					 <select class="col-xs-11 col-sm-10" datatype="*" disabled="disabled"  type="text"  fieldname="BIANGENG_TYPE">
					 	<option value=""></option>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input disabled="disabled" class="col-xs-11 col-sm-11"  type="hidden" id="BIANGENG_COMPANYS" fieldname="BIANGENG_COMPANY"  />
					  <input disabled="disabled" class="col-xs-11 col-sm-11"  type="text"  id="BIANGENG_NAMES"  />
				</div>
			</div>
	  		<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
				...
				<div class="col-sm-10">
					 <textarea disabled="disabled" autofocus="autofocus" type="text"  fieldname="REASON" class="col-xs-11 col-sm-11" ></textarea>					
				</div>
			</div>
	  		<div class="form-group" >
		  		<label class="col-sm-2 control-label no-padding-right">
				...
				<div class="col-sm-4">
					 <input disabled="disabled" class="col-xs-11 col-sm-11"  type="text"  fieldname="AMOUNT" datatype="/^\d{0,16}\.(\d{1,2})$|^\d{0,18}$/" errormsg="金额格式不对，此处最多保留2位小数" ignore="ignore"  />元
				</div>				
			</div>	
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <input  class="col-xs-11 col-sm-11" type="text" disabled="disabled" fieldname="CREATBY" readonly="readonly" />
				</div>
		  		<label class="col-sm-2 control-label no-padding-right">
					创建日期：
				</label>
				<div class="col-sm-4">
					 <input disabled="disabled" class="col-xs-11 col-sm-11" type="text"  fieldname="CREATE_DATE" readonly="readonly" />
				</div>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <input disabled="disabled" class="col-xs-11 col-sm-11" type="text"  fieldname="UPDATEBY" readonly="readonly" />
				</div>
		  		<label class="col-sm-2 control-label no-padding-right">
					更新日期：
				</label>
				<div class="col-sm-4">
					 <input disabled="disabled"  class="col-xs-11 col-sm-11" type="text"  fieldname="UPDATE_DATE" readonly="readonly" />
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<table  role="presentation" class="table table-striped">
						<tbody class="files showFileTab" onlyView="true" showType="width:120px;height:120px;quanxian:false;heightss:160px;heights:40px;del:false;attr:multi;preview:false;" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10401"></tbody>
					</table>
				</div>
			</div>
     </form>
