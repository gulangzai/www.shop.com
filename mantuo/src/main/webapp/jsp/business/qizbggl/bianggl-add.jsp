...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">添加变更管理</h3>
  </div>
	  	 ...
	  	 <input type="hidden" id="target_uid" fieldname="target_uid"  />	  	
	  		<div class="form-group" >
		  		<label class="col-sm-2 control-label no-padding-right">
					变更日期：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-4">
					 <input id="biangengDate2" class="col-xs-11 col-sm-11"  data-date-format="yyyy-mm-dd" datatype="*" nullmsg = "请输入变更日期"  placeholder="请输入变更日期" type="text"  fieldname="BIANGENG_DATE"  />
				</div>
				
		  		<label class="col-sm-2 control-label no-padding-right">
					变更类型：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-4">
					 <select class="col-xs-11 col-sm-10" datatype="*" nullmsg = "请选择变更类型"  placeholder="请选择变更类型" type="text"  fieldname="BIANGENG_TYPE">
	  		...
	  		<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
					变更发起单位：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-10">
					 <input class="col-xs-11 col-sm-11"  datatype="*"  type="hidden" id="BIANGENG_COMPANYS" fieldname="BIANGENG_COMPANY" disabled="disabled" />
					 <input class="col-xs-11 col-sm-11" datatype="*" nullmsg = "请选择变更发起单位"  placeholder="请选择变更发起单位" type="text" id="BIANGENG_NAME"  disabled="disabled" />
				     <i class="ace-icon glyphicon glyphicon-list bigger-110" onclick="selectGuifan();" style="cursor:pointer" title="选择项目参建单位"></i>
				</div>
			</div>
	  		<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
					变更理由：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-10">
					 <textarea autofocus="autofocus" nullmsg = "请输入变更理由"  placeholder="请输入变更理由"  datatype="*" type="text"  fieldname="REASON" class="col-xs-11 col-sm-11" ></textarea>					
				</div>
			</div>
	  		<div class="form-group" >
		  		<label class="col-sm-2 control-label no-padding-right">
				...
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-11" nullmsg = "请输入变更金额"  placeholder="请输入变更金额"  type="text"  fieldname="AMOUNT" datatype="/^\d{0,16}\.(\d{1,2})$|^\d{0,18}$/" errormsg="金额格式不对，此处最多保留2位小数" ignore="ignore" />元
				</div>				
			</div>	
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <label class="col-sm-5 center"><input  type="radio" name="important" fieldname="IMPORTANT" value="Y" />是</label>
					 <label class="col-sm-5 center"><input  type="radio" name="important" checked fieldname="IMPORTANT" value="N" />否</label>
					 <!-- <input id="_important" type="hidden"  fieldname="IMPORTANT"/> -->
				</div>				
			</div>	
