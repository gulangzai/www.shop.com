...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">修改变更管理</h3>
  </div>
 	   ...
 	   <!-- 获取 项目 的 uid -->
	  	 ...
	  	 <input type="hidden" id="target_uid" fieldname="target_uid"  />	  	
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <select class="col-xs-11 col-sm-10" datatype="*"  type="text"  fieldname="BIANGENG_TYPE">
					 	<option value=""></option>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea autofocus="autofocus" datatype="*" type="text"  fieldname="REASON" class="col-xs-11 col-sm-11" ></textarea>					
				</div>
			</div>
	  		<div class="form-group" >
		  		<label class="col-sm-2 control-label no-padding-right">
