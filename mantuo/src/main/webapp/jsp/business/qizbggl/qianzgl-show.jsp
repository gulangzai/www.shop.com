...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看现场签证</h3>
  </div>
 	   ...
 	   <!-- 获取 项目 的 uid -->
	  	 ...
	  	 <input type="hidden" id="target_uid" fieldname="target_uid"  />	  	
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <input id="biangengDate22" disabled="disabled" class="col-xs-11 col-sm-11"  data-date-format="yyyy-mm-dd"  nullmsg = "请输入日期"  placeholder="请输入日期" type="text"  fieldname="BIANGENG_DATE"  />
				</div>
				<!-- 
		  		<label class="col-sm-2 control-label no-padding-right">
					签证类型：
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input class="col-xs-11 col-sm-11" disabled="disabled"  type="hidden" id="BIANGENG_COMPANYS" fieldname="BIANGENG_COMPANY"  />
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <input disabled="disabled" class="col-xs-11 col-sm-11" type="text"  fieldname="CREATBY" readonly="readonly" />
				</div>
		  		<label class="col-sm-2 control-label no-padding-right">
					创建日期：
				</label>
				...
				<!-- 
				 ...
				 -->	
					<table  role="presentation" class="table table-striped">
						<tbody onlyView="true" class="files showFileTab" showType="width:120px;height:120px;quanxian:false;heightss:160px;heights:40px;del:false;attr:multi;preview:false;" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10401"></tbody>
					</table>
				</div>
			</div>
     </form>
