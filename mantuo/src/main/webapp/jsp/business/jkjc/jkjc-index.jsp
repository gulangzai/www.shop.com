		...
		<div style="width: 100%;  position: relative;">
			<!-- DIV  height: 145px; -->
				...
				<div id="detailed" style="position:absolute; top:-650px;  z-index: 100;height:495px; width:80%; left:10%; background-color:#f6fbfb;display: none;">
									 ...
									 <div class="tab-content" id="tbDiv">
									 	<div class="tab-pane in active" id="home" >
											 ...
											 role="form" style="line-height:40px;vertical-align:middle;">
									       	...
									       	<div id="linechart2" style="height:480px;width: 400px;float: left;margin-top:20px;" >
						       	
									       	</div>
									       	<div id="linechart3" style="height:480px;width: 400px;float: right;margin-top:20px;" >
									       	
									       	</div>
									       	
									       	<div id="barchar2" style="height:380px;width: 400px;float: left;" >
									       	
									       	</div>
			
									       	<div id="barchar3" style="height:380px;width: 400px;float: right;" >
				    ...
				    <input type="hidden" id="fromType" value="基坑">
	      </div>
     </div>
   </div>
</div>
