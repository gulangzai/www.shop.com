	...
	<div class="main-container" id="main-container">
		    ...
		    <!-- form 开始 位置 -->
					<form class="form-inline"  id="queryForm01" width="100%"
					   role="form" style="border:solid 1px #ddd;height:50px;line-height:50px;vertical-align:middle;">
						...
						<div class="form-group">
						  <span id="getSelect" style="font-size:15px;line-height: 50px;">&nbsp;添加设施设备</span>
						...
						<div class="form-group right" >
						  <input class="searchContent form-control" style="width: 150px;" name="" fieldname="EQUIPMENT_NAME" id="" operation="like" logic="and">
				   ...
				   <form id="dataCheckBox01">
				      <!-- 当前 选择的 checkbox -->
				       <input class="hidden" id="strUid" type="hidden" fieldname="JK_EQUIP_INFO_UID"/>
				    </form>
					    <table   sortname="JK_EQUIP_INFO_UID" multiselect=false  rownum="1000000" sortorder="asc"  class=""  id="grid_table" 
									action="${ctx}/jcsb/jcJkEquipInfoController?query" >
							<tr>
							     <th name="JK_EQUIP_INFO_UID" formatter="formatEdit" width="1" align="center">选择</th>
								<th name="EQUIPMENT_UID"  width="2" align="center">设备ID</th>
								<th name="EQUIPMENT_NAME"  width="2" align="center">设备名称</th>
								<th name="STATUS" width="2" align="center" >运行状态</th>
								<th name="PERSON" width="2" align="center" >操作人员</th>
								<th name="BEGIN_TIME" width="2" align="center" >进场时间</th>
								<th name="END_TIME" width="2" align="center" >出场时间</th>
							</tr> 
						</table> 
...
function init(){	
	...
	$('#newDel').click(function (){
		//获取 选择的列
		   var v="";
		   $("#grid_table input:checkbox[name='JK_EQUIP_INFO_UID']:checked").each(function() {
				v += $(this).val() + "," ;
			});
			if (v.length != 0) {
...
function formatEdit(cellvalue, opts, rowObject){
	...
	var showHtml ="<div class='hidden-sm hidden-xs action-buttons' id='getValue'>";			        	
		showHtml +="<input id=\"jcEuid"+jceid+"\" type=\"checkbox\" name=\"JK_EQUIP_INFO_UID\" value =\""+jceid+"\" ";
		showHtml +="</div>";
	return 	showHtml;	
