...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">修改设备材料信息</h3>
  </div>
      	 ...
      	 <input id="PROJECT_UID" type="hidden" name="PROJECT_UID" fieldname="PROJECT_UID" value="<%=PROJECT_UID%>" />
      	  ...
      	  <input type="hidden" id="target_uid" fieldname="target_uid"  />
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input datatype="*" nullmsg = "请输入设备材料名称"  placeholder="请输入设备材料名称" type="text" name="CAILIAO_NAME" id="CAILIAO_NAME" fieldname="CAILIAO_NAME" class="col-xs-11 col-sm-11"/>
				</div>	  		
			</div>
	  		...
	  		<div class="form-group" >	
				...
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"  datatype="*" nullmsg = "请输入品牌"  placeholder="请输入品牌" type="text"  id="CAILIAO_PINPAI" name="CAILIAO_PINPAI" fieldname="CAILIAO_PINPAI"/>
				</div>
	  		    <label class="col-sm-2 control-label no-padding-right">
					生产商：
				</label>
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"    type="text"  id="CAILIAO_CHANGSHANG" name= "CAILIAO_CHANGSHANG" fieldname="CAILIAO_CHANGSHANG"/>
				</div>
			</div>
			     <div class="form-group" >	
		  		<label class="col-sm-2 control-label no-padding-right">
				...
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"    type="text"  id="CAILIAO_CHANDI" name="CAILIAO_CHANDI" fieldname="CAILIAO_CHANDI"/>
				</div>
	  		    <label class="col-sm-2 control-label no-padding-right">
					规格型号：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"  datatype="*" nullmsg = "请输入规格型号"  placeholder="请输入规格型号" type="text"  id="CAILIAO_XINGHAO" name="CAILIAO_UNIT" fieldname="CAILIAO_XINGHAO"/>
				</div>
			</div>
			<div class="form-group" >	
		  		<label class="col-sm-2 control-label no-padding-right">
				...
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"  datatype="*" nullmsg = "请输入单位"  placeholder="请输入单位" type="text"  id="CAILIAO_UNIT" name="CAILIAO_UNIT" fieldname="CAILIAO_UNIT" />
				</div>
				<label class="col-sm-2 control-label no-padding-right">
					数量：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"  datatype="/^\d{0,16}\.(\d{1,2})$|^\d{0,18}$/" errormsg="数量格式不对，此处最多保留2位小数"   nullmsg = "请输入数量"  placeholder="请输入数量" type="text"  id="CAILIAO_NUMS" name="CAILIAO_NUMS" fieldname="CAILIAO_NUMS"/>
				</div>
            ...
            <div class="form-group">
				...
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"  datatype="/^\d{0,16}\.(\d{1,2})$|^\d{0,18}$/" errormsg="价格格式不对，此处最多保留2位小数"   type="text"  id="CAILIAO_PRICE" name="CAILIAO_PRICE" fieldname="CAILIAO_PRICE"/>
				</div>
            </div>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"  data-date-format="yyyy-mm-dd" datatype="*" nullmsg = "请输入进场日期"  placeholder="请输入进场日期" type="text" id="CAILIAO_JCRQ" name="CAILIAO_JCRQ" fieldname="CAILIAO_JCRQ" />
				</div>
				<label class="col-sm-2 control-label no-padding-right">
					验收人：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-4">
					 <input class="col-xs-11 col-sm-10"  datatype="*" nullmsg = "请输入验收人"  placeholder="请输入验收人" type="text"  id="YANSHOU_REN" name="YANSHOU_REN" fieldname="YANSHOU_REN"/>
				</div>
...
-->
					<table  role="presentation" class="table table-striped">
						<tbody class="files showFileTab" showType="width:120px;height:120px;quanxian:true;heightss:160px;heights:40px;del:false;attr:multi;preview:false;" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10501"></tbody>
					</table>
