...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">添加监理日志</h3>
  </div>
 	   ...
 	   <!-- 获取 项目 的 uid -->    	
      	 ...
      	 <input type="hidden" id="target_uid" fieldname="target_uid"  />	
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input datatype="*" nullmsg = "请输入单位工程名称"  placeholder="请输入单位工程名称" type="text" name="REPORT_DATE" id="REPORT_DATE_TWO" fieldname="REPORT_DATE" class="col-xs-11 col-sm-11" />
				</div>
			 ...
			 -->
	  		...
	  		<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
					主要工作简述：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-10">
					 <textarea  datatype="*" nullmsg="请输入主要工作简述"  placeholder="请输入主要工作简述" type="text" name="GONGZUO_INFO" id="GONGZUO_INFO" fieldname="GONGZUO_INFO" class="col-xs-11 col-sm-11" ></textarea>
					
				</div>
			</div>
	  		<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
				有关问题处理澄清情况简述：<span class="required-indicator">*</span>
				</label>
				<div class="col-sm-10">
					 <textarea  datatype="*" nullmsg="请输入有关问题处理澄清情况简述"  placeholder="请输入有关问题处理澄清情况简述" type="text" name="CQQK_INFO" id="CQQK_INFO" fieldname="CQQK_INFO" class="col-xs-11 col-sm-11" ></textarea>
			...
			-->
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea autofocus="autofocus"    placeholder="请输入突发事件" type="text" id="TUFA" fieldname="TUFA" class="col-xs-11 col-sm-11" ></textarea>
