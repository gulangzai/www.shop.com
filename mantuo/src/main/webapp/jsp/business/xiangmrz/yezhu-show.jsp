...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看业主日志</h3>
  </div>
 	   ...
 	   <!-- 获取 项目 的 uid -->    	
      	 ...
      	 <input type="hidden" id="target_uid" fieldname="target_uid"  />	
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea  datatype="*" disabled="disabled" nullmsg="请输入业主日报标题"  placeholder="请输入业主日报标题" type="text" name="YZLOG_TITLE" id="YZLOG_TITLE" fieldname="YZLOG_TITLE" class="col-xs-11 col-sm-11" ></textarea>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea autofocus="autofocus" disabled="disabled" datatype="*" nullmsg="请输入业主日报内容"   placeholder="请输入业主日报内容" type="text" id="YZLOG_CONTENT" name="YZLOG_CONTENT" fieldname="YZLOG_CONTENT" class="col-xs-11 col-sm-11" ></textarea>
