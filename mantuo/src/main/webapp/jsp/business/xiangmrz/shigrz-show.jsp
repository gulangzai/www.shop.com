...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看施工日志</h3>
  </div>
 	   ...
 	   <!-- 获取 项目 的 uid -->    	
	  	 ...
	  	 <input type="hidden" id="target_uid" fieldname="target_uid"  />
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input class="col-xs-11 col-sm-11" disabled="disabled" data-date-format="yyyy-mm-dd" datatype="*" nullmsg = "请输入日期"  placeholder="请输入日期" type="text" id="SLOG_DATE" fieldname="LOG_DATE"  />
				</div>
			</div>
	  		<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
				...
				<div class="col-sm-10">
					 <textarea autofocus="autofocus"  datatype="*" disabled="disabled" nullmsg="请输入生产情况记录"  placeholder="请输入生产情况记录" type="text"  fieldname="SHENGCHAN_INFO" class="col-xs-11 col-sm-11" ></textarea>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea autofocus="autofocus" disabled="disabled" datatype="*" nullmsg="请输入质量安全情况记录"  placeholder="请输入质量安全情况记录" type="text"  fieldname="ZLAQ_INFO" class="col-xs-11 col-sm-11" ></textarea>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea autofocus="autofocus" disabled="disabled"  placeholder="请输入突发事件" type="text"  fieldname="TUFA" class="col-xs-11 col-sm-11" ></textarea>
