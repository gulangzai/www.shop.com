...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看监理日志</h3>
  </div>
	  ...
	  <form id="queryFormById">
 	  ...
 	  <form method="post" role="form" class="form-horizontal"  id="executeFrm" > 
 	   <!-- 获取 项目 的 uid -->    	
      	 ...
      	 <input id="LOG_TYPE" type="hidden" name="LOG_TYPE" fieldname="LOG_TYPE" value="JL"/>
      	 <input type="hidden" id="target_uid" fieldname="target_uid"  />	
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <input class="col-xs-11 col-sm-11" disabled="disabled" data-date-format="yyyy-mm-dd" datatype="*" nullmsg = "请输入日期"  placeholder="请输入日期" type="text" id="LLOG_DATE" fieldname="LOG_DATE"  />
				</div>
			</div>
	  		<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
				...
				<div class="col-sm-10">
					 <textarea disabled="disabled"  datatype="*" nullmsg="请输入主要工作简述"  placeholder="请输入主要工作简述" type="text" name="GONGZUO_INFO" id="GONGZUO_INFO" fieldname="GONGZUO_INFO" class="col-xs-11 col-sm-11" ></textarea>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea disabled="disabled"  datatype="*" nullmsg="请输入有关问题处理澄清情况简述"  placeholder="请输入有关问题处理澄清情况简述" type="text" name="CQQK_INFO" id="CQQK_INFO" fieldname="CQQK_INFO" class="col-xs-11 col-sm-11" ></textarea>
	  		...
	  		<div class="form-group" >
				...
				<div class="col-sm-10">
					 <textarea disabled="disabled" autofocus="autofocus"    placeholder="请输入突发事件" type="text" id="TUFA" fieldname="TUFA" class="col-xs-11 col-sm-11" ></textarea>
	  		...
	  		<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<table  role="presentation" class="table table-striped">
						<tbody onlyView="true" class="files showFileTab" showType="width:120px;height:120px;quanxian:false;heightss:160px;heights:40px;del:false;attr:multi;preview:false;" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10109"></tbody>
					</table>
				</div>
			</div>	
     </form>
