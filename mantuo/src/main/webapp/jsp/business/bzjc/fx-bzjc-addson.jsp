...
<%
	...
	String P_BZJC_UID  = request.getParameter("BZJC_UID"); 
...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
   <div class="widget-header widget-header-large">
    	...
    	<h3 id="myModalLabel" class="blue bigger">添加飞行标准检查子节点</h3>
  </div>
  <div class="modal-body">
 	  <form method="post" role="form" class="form-horizontal"  id="executeFrmZL" > 
 	   <!-- 获取 项目 的 uid -->    	
	  	  ...
	  	  <input type="hidden" id="LEVEL" fieldname="LEVEL"  value="2"/> 
	  	  <input type="hidden" id="JC_TYPE" fieldname="JC_TYPE"  value="FX"/> 
	  	  <input type="hidden" id="P_BZJC_UID" fieldname="P_BZJC_UID" value="<%=P_BZJC_UID%>">
