	...
	<div class="main-container" id="main-container">
		    ...
		    <!-- form 开始 位置 -->
					...
					<!--<input id="selectId" placeholder="发放单位" class="form-control" onclick="select();" style="width: 150px; height: 25px;border-radius: 8px 8px 8px 8px; border: 1px solid #d1d2d9;
					    ...
					    <table  sortname="JC_END_DATE"   rownum="1000000"  sortorder="desc"  class="" id="grid_table"  ExpandColumn="BZJC_NAME"
									action="${ctx}/pmbzjc/pmBzjcController/queryTree?JC_TYPE=BZ" >
							<tr>
								...
								<th name="PLAN_JC_DATE"  align="center" width="4" formatter="" >计划完成时间</th>
								<th name="JC_END_DATE"  align="center" width="4" formatter="" >实际完成时间</th>
...
function init(){	
	...
	/*$('#newAdd').click(function() {
		...
		$.get("${ctx}/jsp/business/jcgl/check-jcbz.jsp",function(data) {
			$("#xmgk-input").empty();
			$("#xmgk-input").html("");
...
function showFileList(project_uid,bzjc_uid,jc_type){
    ...
    $('#newAdd').attr("data-target","xmgk-input");
		...
		$.get("${ctx}/jsp/business/bzjc/bz-bzjc-detail.jsp?PROJECT_UID="+project_uid+"&BZJC_UID="+bzjc_uid+"&JC_TYPE="+jc_type,function(data) {
			$("#xmgk-input").empty();
			$("#xmgk-input").html("");
			$("#xmgk-input").html(data);
		});
...
function eidtXcZlxx(project_uid,bzjc_uid,jc_type){
		...
		$.get("${ctx}/jsp/business/bzjc/bz-bzjc-edit.jsp?PROJECT_UID="+project_uid+"&BZJC_UID="+bzjc_uid+"&JC_TYPE="+jc_type,function(data) {
			$("#xmgk-input").empty();
			$("#xmgk-input").html("");
			$("#xmgk-input").html(data);
		});
...
function fankui(project_uid,bzjc_uid,jc_type){
	...
	$.get("${ctx}/jsp/business/bzjc/bz-bzjc-fankui.jsp?PROJECT_UID="+project_uid+"&BZJC_UID="+bzjc_uid+"&JC_TYPE="+jc_type,function(data) {
		$("#xmgk-input").empty();
		$("#xmgk-input").html("");
		$("#xmgk-input").html(data);
	});
...
function addson(project_uid,bzjc_uid,jc_type){
	...
	$.get("${ctx}/jsp/business/bzjc/bz-bzjc-addson.jsp?PROJECT_UID="+project_uid+"&BZJC_UID="+bzjc_uid+"&JC_TYPE="+jc_type,function(data) {
		$("#xmgk-input").empty();
		$("#xmgk-input").html("");
		$("#xmgk-input").html(data);
	});
