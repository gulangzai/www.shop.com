...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
   <div class="widget-header widget-header-large">
    	...
    	<h3 id="myModalLabel" class="blue bigger">查看</h3>
  </div>
      	 ...
      	 <%--  <input  id="XM_PRJ_STRUC_UID"  type="hidden"  fieldname="PRJ_STRUC_UID" value="" />--%>
		    ...
		    <div class="form-group" >
			 ...
			 <div class="form-group" >
				...
				<div class="col-sm-10">
				 <input value="" id="SGDW" datatype="*" nullmsg="请选择施工单位"     placeholder="请选择施工单位" type="hidden"  fieldname="SGDW" class="col-xs-11 col-sm-11"/>
				  <input value="" id="SGDWS" datatype="*" nullmsg="请选择施工单位"     placeholder="请选择施工单位" type="text"   class="col-xs-11 col-sm-11"/>
				</div>
			</div>
			<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
				...
				<div class="col-sm-3">
				 <input value=""  id="" datatype="*" nullmsg="请输入施工单位负责人"    placeholder="请输入施工单位负责人" type="text"  fieldname="SGDW_JSFZR" class="col-xs-11 col-sm-10"/>
				</div>
			...
			<div class="form-group" >
				...
				<div class="col-sm-10">
				 <input value="" id="FBDW" datatype="*" nullmsg="请选择分包单位"    placeholder="请选择分包单位" type="hidden"  fieldname="FBDW" class="col-xs-11 col-sm-11"/>
				 <input value="" id="FBDWS" datatype="*" nullmsg="请选择分包单位"    placeholder="请选择分包单位" type="text"   class="col-xs-11 col-sm-11"/>
				</div>
			</div>
			<div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
				...
				<div class="col-sm-4">
				 <input  value=""  id="" datatype="*" nullmsg="请输入分包单位负责人"    placeholder="请输入分包单位负责人" type="text"  fieldname="FBDW_FZR" class="col-xs-11 col-sm-10"/>
				</div>
				<label class="col-sm-2 control-label no-padding-right" >
	...
	<!-- -------------------------------------------------------------- -->	  
		   ...
		   <div class="form-group  group_FB_AQGN_JC" >
			...
			<div class="form-group  group_ZX_KGRQ" style="display:none">
				...
				<div class="col-sm-10">
				 <input  class="REPORT_DATE1" type="text" id="ZX_KGRQ" data-date-format="yyyy-mm-dd" nullmsg="请输入专项工程开工日期"  style="height: 25px;border-radius: 8px 8px 8px 8px; border: 1px solid #d1d2d9;"    placeholder="请输入专项工程开工日期"   fieldname="ZX_KGRQ" class="col-xs-11 col-sm-11"/>
				</div>
			</div>
			...
			<div class="form-group group_ZX_WCRQ" style="display:none">
				...
				<div class="col-sm-10">
				 <input    class="REPORT_DATE1" type="text" id="ZX_WCRQ" data-date-format="yyyy-mm-dd" nullmsg="请输入专项工程完成日期" style="height: 25px;border-radius: 8px 8px 8px 8px; border: 1px solid #d1d2d9;"    placeholder="请输入专项工程完成日期"    fieldname="ZX_WCRQ" class="col-xs-11 col-sm-11"/>
				</div>
			</div>
...
<!-- ------------------------------------------------------------------ -->				
		  ...
		  <div class="form-group" >
				...
				<div class="col-sm-10">
				 <input  class="REPORT_DATE1" type="text" datatype="*" data-date-format="yyyy-mm-dd" style=" height: 25px;border-radius: 8px 8px 8px 8px; border: 1px solid #d1d2d9;"  fieldname="YSRQ" class="col-xs-11 col-sm-11"/>
				</div>
			</div>
		   <div class="form-group" >
	  			<label class="col-sm-2 control-label no-padding-right" >
            ...
            <div class="form-group" >
				 ...
				 <div class="col-sm-10"> 
				 <input  class="REPORT_DATE_ONE" type="text" datatype="*" data-date-format="yyyy-mm-dd" nullmsg="请输入复查日期 "  style="height: 25px;border-radius: 8px 8px 8px 8px; border: 1px solid #d1d2d9;"    fieldname="FCRQ" class="col-xs-11 col-sm-11"/>
				 </div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-sm-9">
					<span style="margin:4px auto;display:none" class="btn  btn-white btn-default btn-round " onclick="selectFile(this);" file_type="10701" >
					...
					<table  role="presentation" class="table table-striped">
						<tbody onlyView="true" showType="width:120px;height:120px;quanxian:false;heightss:160px;heights:40px;attr:multi;preview:false"  class="files showFileTab" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10701" fjlb="media"></tbody>
					</table>
				</div>
			</div>
     </form> 
...
function gradeChange(){
	...
	$("#yanshouseeFormResult input").attr("disabled","disabled");
			...
			$.ajax({
				...
				success : function(response) {
					...
					obj.forEach(function(obj){
						...
						.append($("<td></td>").append(obj.DETAIL_NAME))
						.append($("<td></td>").append(obj.DETAIL_NUMS))
						.append($("<td></td>").append(obj.DETAIL_BUWEI))
						.append($("<td></td>").append(obj.DETAIL_JCJG))
						.append($("<td></td>").append(obj.DETAIL_YSJL)); 
