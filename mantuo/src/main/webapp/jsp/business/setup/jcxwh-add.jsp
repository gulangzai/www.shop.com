	...
	$("#saveBtn").click(function() {
	  if(validform.check()){
		...
		if($("#executeFrm").validationButton()) {
			...
			$.ajax({
				url :'${ctx}/jkjc/jcPrjJcItemController?insert',
				data : data1,
				cache : false,
				async :	false,
				dataType : "json",  
