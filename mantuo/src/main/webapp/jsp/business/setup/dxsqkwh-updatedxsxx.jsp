...
<%
 String DXS_UID =request.getParameter("DXS_UID");
 %>
<!-- Modal -->
<div class="modal-dialog width-50 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">修改地下水情况</h3>
  </div>
  <div class="modal-body">

 	  <form method="post" role="form" class="form-horizontal"  id="executeFrm" > 
      	 <input type="hidden" name="DXS_UID" fieldname="DXS_UID" value="<%=DXS_UID %>" />
...
function  setFormValues(){
 	      $.ajax({
				url :controlletname+'?queryDxsById&DXS_UID='+"<%=DXS_UID%>",
				cache : false,
				async :	false,
				dataType : "json",  
				type : 'post',
