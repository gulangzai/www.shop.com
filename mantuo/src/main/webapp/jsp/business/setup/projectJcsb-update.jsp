...
<div class="modal-dialog width-70 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">修改设备维护</h3>
  </div>
 	  ...
 	  <form method="post" role="form" class="form-horizontal"  id="executeFrm" > 
 	   <!-- 获取 项目 的 uid -->    	
      	 <input id="PROJECT_UID" type="hidden" name="PROJECT_UID" fieldname="PROJECT_UID" />
      	 	<input type="hidden"  kind="text" id="EQUIPMENT_UID"  fieldname="EQUIPMENT_UID" value="<%=EUID%>" operation="="/>
...
function setFormValues(){
	...
	$.ajax({
		url : controlletname+"?queryCondition",
		data : data1,
		cache : false,
		async :	false,
		dataType : "json",  
   ...
   <!--可以再此处加入hidden域作为过滤条件 -->
   	<TR  style="display:none;">
     	<TD class="right-border bottom-border">
      	<INPUT type="text"  kind="text" id="EQUIPMENT_UID"  fieldname="t.EQUIPMENT_UID" value="<%=EUID%>" operation="="/>
      	</TD>
		<TD class="right-border bottom-border">
		</TD>
     </TR>
