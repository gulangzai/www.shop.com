...
<div class="modal-dialog width-60 height-auto">
  <div class="modal-content" >
    	...
    	<h3 id="myModalLabel" class="blue bigger">添加问题讨论</h3>
  </div>
<div class="modal-body">

	<form method="post" role="form" class="form-horizontal"  id="executeFrm" > 
	     <input id="TPROJECT_UID" type="hidden"  fieldname="PROJECT_UID"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<span class="btn  btn-white btn-default btn-round" id="addFileSpan" onclick="selectFile(this);" file_type="10301" >
					<i class="ace-icon fa fa-upload"></i>
					<span>附件上传</span>
				</span>
				<table  role="presentation" class="table table-striped">
					<tbody class="files showFileTab" data-toggle="modal-gallery" data-target="#modal-gallery"  file_type="10301" fjlb=""></tbody>
				</table>
...
$(function() {	
	...
	$('#TPROJECT_UID').val($('#project_uid').val());
...
function selectFile(obj){
	...
	setFileData("PM_PROJECT_TOPIC","PROJECT_TOPIC_UID",targetUid,file_type);
