            ...
            createProgressBar: function (days, id, cls, desc, label, dataObj,nullType,fromDate,toDate) {
                ...
                if(days==1){//计划日期等于实际日期
                	 if(nullType==""||nullType==null){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart.png"></image><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd.png"></image></div></div></div>');
                	 }else if(nullType=="from"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart-h.png"></image><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd.png"></image></div></div></div>');
                	 }else if(nullType=="all"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart-h.png"></image><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd-h.png"></image></div></div></div>'); 
                	 }else if(nullType=="to"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart.png"></image><image src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd-h.png"></image></div></div></div>'); 
                	 }
                }else{
                	if(fromlessto == false){
                		if(nullType==""||nullType==null){
                       		bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="from"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart-h.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="all"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart-h.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="to"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }
                 		...
                 		if(nullType==""||nullType==null){
                       		bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="from"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="all"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd-h.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="to"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtEnd-h.png"></div><div class="gtEnd"><img src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/img/gtStart.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }
                	}
