...
<link href="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/css/style.css" rel="stylesheet" media="screen">
		<style type="text/css">
			body {
...
<script src="${pageContext.request.contextPath }/assets/sys_resources/plugins/gantt/js/jquery.fn.gantt.js"></script>
    <script>
